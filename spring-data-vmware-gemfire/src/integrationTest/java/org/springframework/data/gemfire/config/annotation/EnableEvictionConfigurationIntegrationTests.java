...
public class EnableEvictionConfigurationIntegrationTests extends SpringApplicationContextIntegrationTestsSupport {
	...
	private void assertRegionEvictionConfiguration(ConfigurableApplicationContext applicationContext,
		...
		Assertions.assertThat(region.getAttributes().getEvictionAttributes()).isNotNull();

		Assertions.assertThat(region.getAttributes().getEvictionAttributes().getAction())
			.isEqualTo(expectedEvictionActionType.getEvictionAction());

		Assertions.assertThat(region.getAttributes().getEvictionAttributes().getAlgorithm())
			.isEqualTo(EvictionPolicyType.ENTRY_COUNT.getEvictionAlgorithm());

		Assertions.assertThat(region.getAttributes().getEvictionAttributes().getMaximum()).isEqualTo(expectedEvictionMaximum);
	}

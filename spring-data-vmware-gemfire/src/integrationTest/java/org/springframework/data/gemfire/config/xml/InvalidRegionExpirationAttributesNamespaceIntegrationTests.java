...
public class InvalidRegionExpirationAttributesNamespaceIntegrationTests
	...
	private ConfigurableApplicationContext createApplicationContext() {
		...
		applicationContext.load(IntegrationTestsSupport.getContextXmlFileLocation(InvalidRegionExpirationAttributesNamespaceIntegrationTests.class));
	...
	public void invalidXmlSyntaxThrowsException() {
		...
		try {
			...
			Assertions.assertThat(expected).hasCauseInstanceOf(SAXParseException.class);
			throw expected;
		}
	}
}

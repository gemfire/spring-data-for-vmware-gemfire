...
public class TransactionEventHandlersIntegrationTests extends IntegrationTestsSupport {
	...
	public void transactionEventHandlersConfiguredCorrectly() {
		...
		Assertions.assertThat(listeners.length).isEqualTo(2);
		Assertions.assertThat(listeners[0]).isSameAs(txListener1);
		Assertions.assertThat(listeners[1]).isSameAs(txListener2);
	}

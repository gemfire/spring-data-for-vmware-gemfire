...
public class CachingDefinedRegionsConsidersCacheConfigCacheNamesIntegrationTests
	...
	public void testServiceOneCacheRegionsAreCorrect() {
		Assertions.assertThat(resolveCacheRegionNames(TestConfigurationOne.class)).containsExactlyInAnyOrder("A", "B");
	}

	@Test
	public void testServiceTwoCacheRegionsAreCorrect() {
		Assertions.assertThat(resolveCacheRegionNames(TestConfigurationTwo.class)).containsExactlyInAnyOrder("A", "B");
	}

	@Test
	public void testServiceThreeCacheRegionsAreCorrect() {
		Assertions.assertThat(resolveCacheRegionNames(TestConfigurationThree.class))
			.containsExactlyInAnyOrder("A", "B", "C");
	}

	@Test
	public void testServiceFourCacheRegionsAreCorrect() {
		Assertions.assertThat(resolveCacheRegionNames(TestConfigurationFour.class))

...
public class RegionExpirationAttributesNamespaceIntegrationTests extends IntegrationTestsSupport {
	...
	private void assertRegionMetaData(Region<?, ?> region,
		...
		Assertions.assertThat(region.getName()).isEqualTo(regionName);
		Assertions.assertThat(region.getFullPath()).isEqualTo(regionFullPath);
	...
	private void assertExpirationAttributes(ExpirationAttributes expirationAttributes,
		...
		Assertions.assertThat(expirationAttributes.getTimeout()).isEqualTo(timeout);
		Assertions.assertThat(expirationAttributes.getAction()).isEqualTo(action);
	}
	...
	private void assertCustomExpiry(CustomExpiry<?, ?> customExpiry, String name, int timeout,
		...
		Assertions.assertThat(customExpiry).isNotNull();
		Assertions.assertThat(customExpiry.toString()).isEqualTo(name);
		assertExpirationAttributes(customExpiry.getExpiry(Mockito.mock(Region.Entry.class)), timeout, action);
	}

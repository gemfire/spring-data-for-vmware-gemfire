...
public class DiskStorePropertiesIntegrationTests extends SpringApplicationContextIntegrationTestsSupport {
	...
	private void assertDiskStore(DiskStore diskStore, String name, boolean allowForceCompaction, boolean autoCompact,
		...
		Assertions.assertThat(diskStore.getAllowForceCompaction()).isEqualTo(allowForceCompaction);
		Assertions.assertThat(diskStore.getAutoCompact()).isEqualTo(autoCompact);
		Assertions.assertThat(diskStore.getCompactionThreshold()).isEqualTo(compactionThreshold);
		Assertions.assertThat(diskStore.getDiskUsageCriticalPercentage()).isEqualTo(diskUsageCriticalPercentage);
		Assertions.assertThat(diskStore.getDiskUsageWarningPercentage()).isEqualTo(diskUsageWarningPercentage);
		Assertions.assertThat(diskStore.getMaxOplogSize()).isEqualTo(maxOplogSize);
		Assertions.assertThat(diskStore.getName()).isEqualTo(name);
		Assertions.assertThat(diskStore.getQueueSize()).isEqualTo(queueSize);
		Assertions.assertThat(diskStore.getTimeInterval()).isEqualTo(timeInterval);
		Assertions.assertThat(diskStore.getWriteBufferSize()).isEqualTo(writeBufferSize);
		Assertions.assertThat(diskStore.getSegments()).isEqualTo(segments);
	}
	...
	public void diskStoreConfiguration() {
		...
		Assertions.assertThat(testDiskStore).isNotNull();
		Assertions.assertThat(testDiskStore.getName()).isEqualTo("TestDiskStore");
		Assertions.assertThat(testDiskStore.getAllowForceCompaction()).isTrue();
		Assertions.assertThat(testDiskStore.getAutoCompact()).isTrue();
		Assertions.assertThat(testDiskStore.getCompactionThreshold()).isEqualTo(75);
		Assertions.assertThat(testDiskStore.getDiskUsageCriticalPercentage()).isEqualTo(90.0f);
		Assertions.assertThat(testDiskStore.getDiskUsageWarningPercentage()).isEqualTo(85.0f);
		Assertions.assertThat(testDiskStore.getMaxOplogSize()).isEqualTo(512L);
		Assertions.assertThat(testDiskStore.getQueueSize()).isEqualTo(DiskStoreFactory.DEFAULT_QUEUE_SIZE);
		Assertions.assertThat(testDiskStore.getTimeInterval()).isEqualTo(500L);
		Assertions.assertThat(testDiskStore.getWriteBufferSize()).isEqualTo(DiskStoreFactory.DEFAULT_WRITE_BUFFER_SIZE);
		Assertions.assertThat(testDiskStore.getSegments()).isEqualTo(DiskStoreFactory.DEFAULT_SEGMENTS);
	}
	...
	public void diskStoresConfiguration() {
		...
		Assertions.assertThat(containsBean("TestDiskStoreOne")).isTrue();
		Assertions.assertThat(containsBean("TestDiskStoreTwo")).isTrue();

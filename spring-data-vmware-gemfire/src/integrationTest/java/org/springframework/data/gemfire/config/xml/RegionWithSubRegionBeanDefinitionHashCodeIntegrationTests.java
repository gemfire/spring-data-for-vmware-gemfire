...
public class RegionWithSubRegionBeanDefinitionHashCodeIntegrationTests extends IntegrationTestsSupport {
	...
	public void testNonParentRegionBeanDefinitionHashCode() {
		...
		Assertions.assertThat(nonParentRegionBeanDefinition).isNotNull();
		Assertions.assertThat(nonParentRegionBeanDefinition.hashCode() != 0).isTrue();
	}
	...
	public void testParentRegionBeanDefinitionHashCode() {
		...
		Assertions.assertThat(parentRegionBeanDefinition).isNotNull();
		Assertions.assertThat(parentRegionBeanDefinition.hashCode() != 0).isTrue();
	}
	...
	public void testChildRegionBeanDefinitionHashCode() {
		...
		Assertions.assertThat(childRegionBeanDefinition).isNotNull();
		Assertions.assertThat(childRegionBeanDefinition.hashCode() != 0).isTrue();
	}
}

...
public class ClientRegionUsingDataPolicyAndShortcutIntegrationTests extends IntegrationTestsSupport {
	...
	public void testClientRegionBeanDefinitionWithDataPolicyAndShortcut() {
		...
		try {
			new ClassPathXmlApplicationContext(IntegrationTestsSupport.getContextXmlFileLocation(ClientRegionUsingDataPolicyAndShortcutIntegrationTests.class));
		}
		catch (BeanDefinitionParsingException expected) {

			Assertions.assertThat(expected).hasMessageContaining("Only one of [data-policy, shortcut] may be specified with element");

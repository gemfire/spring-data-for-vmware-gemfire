...
public class EnableContinuousQueriesConfigurationWithExcludedEventsIntegrationTests {
    ...
    public void updateOnlyFreezingTemperatureCount() {
        Assertions.assertThat(updateOnlyFreezingTemperatureCounter.get()).isEqualTo(2);
    }

    @Test
    public void excludeDestroyFreezingTemperatureCount() {
        Assertions.assertThat(excludeDestroyFreezingTemperatureCounter.get()).isEqualTo(6);
    }

    @Test
    public void allFreezingTemperatureCount() {
        Assertions.assertThat(allFreezingTemperatureCounter.get()).isEqualTo(7);
    }

    @Test
    public void excludeAllFreezingTemperatureCount() {
        Assertions.assertThat(excludeAllFreezingTemperatureCounter.get()).isEqualTo(0);
    }

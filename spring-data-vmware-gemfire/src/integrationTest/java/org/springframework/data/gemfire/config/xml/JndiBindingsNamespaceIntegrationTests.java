...
public class JndiBindingsNamespaceIntegrationTests extends IntegrationTestsSupport {
	...
	public void testJndiBindings() throws Exception {
		...
		Assertions.assertThat(dataSourceObject).isInstanceOf(GemFireBasicDataSource.class);

		GemFireBasicDataSource dataSource = (GemFireBasicDataSource) dataSourceObject;

		Assertions.assertThat(dataSource.getJDBCDriver()).isEqualTo("org.apache.derby.jdbc.EmbeddedDriver");
		Assertions.assertThat(dataSource.getLoginTimeout()).isEqualTo(60);
	}
}

...
public class ClientCacheApplicationIntegrationTests extends IntegrationTestsSupport {
	...
	public void echoClientRegionEchoesKeysAsValues() {
		...
		Assertions.assertThat(this.echo.get("hello")).isEqualTo("hello");
		Assertions.assertThat(this.echo.get("test")).isEqualTo("test");
		Assertions.assertThat(this.echo.get("good-bye")).isEqualTo("good-bye");
	}

...
public class RegionConfigurerIntegrationTests extends SpringApplicationContextIntegrationTestsSupport {
	...
	private void assertRegionConfigurerInvocations(Iterable<String> actualRegionBeanNames,
		...
		Assertions.assertThat(actualRegionBeanNames).isNotNull();
		Assertions.assertThat(actualRegionBeanNames).hasSize(expectedRegionBeanNames.length);
		Assertions.assertThat(actualRegionBeanNames).contains(expectedRegionBeanNames);
	}
	...
	public void clientRegionConfigurersCalledSuccessfully() {
		...
		Assertions.assertThat(containsBean("Test")).isTrue();
		Assertions.assertThat(containsBean("Sessions")).isTrue();
		Assertions.assertThat(containsBean("GenericRegionEntity")).isTrue();
		Assertions.assertThat(containsBean("testRegionConfigurerOne")).isTrue();
		Assertions.assertThat(containsBean("testRegionConfigurerTwo")).isTrue();
		Assertions.assertThat(containsBean("testRegionConfigurerThree")).isTrue();

...
public class EnableCachingDefinedRegionsIntegrationTests extends IntegrationTestsSupport {
	...
	public void cacheRegionsExists() {
		...
		Assertions.assertThat(gemfireCache.getRegion("/Echo")).isNotNull();
		Assertions.assertThat(gemfireCache.getRegion("/JCacheOne")).isNotNull();
		Assertions.assertThat(gemfireCache.getRegion("/JCacheTwo")).isNotNull();
		Assertions.assertThat(gemfireCache.getRegion("/SpringOne")).isNotNull();
	}

	@Test
	public void echoServiceCachingWithJCacheIsSuccessful() {

		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isFalse();
		Assertions.assertThat(jcacheEchoService.echo("four")).isEqualTo("four");
		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(jcacheEchoService.echo("five")).isEqualTo("five");
		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(jcacheEchoService.echo("four")).isEqualTo("four");
		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isFalse();
		Assertions.assertThat(jcacheEchoService.echo("six")).isEqualTo("six");
		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(jcacheEchoService.echo("five")).isEqualTo("five");
		Assertions.assertThat(jcacheEchoService.isCacheMiss()).isFalse();
	}
	...
	public void echoServiceCachingWithSpringIsSuccessful() {
		...
		Assertions.assertThat(springEchoService.isCacheMiss()).isFalse();
		Assertions.assertThat(springEchoService.echo("one")).isEqualTo("one");
		Assertions.assertThat(springEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(springEchoService.echo("two")).isEqualTo("two");
		Assertions.assertThat(springEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(springEchoService.echo("one")).isEqualTo("one");
		Assertions.assertThat(springEchoService.isCacheMiss()).isFalse();
		Assertions.assertThat(springEchoService.echo("three")).isEqualTo("three");
		Assertions.assertThat(springEchoService.isCacheMiss()).isTrue();
		Assertions.assertThat(springEchoService.echo("two")).isEqualTo("two");
		Assertions.assertThat(springEchoService.isCacheMiss()).isFalse();
	}

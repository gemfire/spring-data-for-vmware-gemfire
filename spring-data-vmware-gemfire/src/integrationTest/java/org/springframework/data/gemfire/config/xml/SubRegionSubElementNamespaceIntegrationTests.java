...
public class SubRegionSubElementNamespaceIntegrationTests extends IntegrationTestsSupport {
	...
	public void testCustomersAccountsSubRegionCacheListener() {
		...
		Assertions.assertThat(customersAccountsRegion).isNotNull();
		Assertions.assertThat(customersAccountsRegion.getAttributes()).isNotNull();
		Assertions.assertThat(customersAccountsRegion.getAttributes().getCacheListeners()).isNotNull();

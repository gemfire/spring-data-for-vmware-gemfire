...
public class AutoConfiguredAuthenticationConfigurationIntegrationTests {
	...
	public static void setupGemFireServer() {
		...
		gemFireCluster.withGemFireProperty(GemFireCluster.ALL_GLOB, "security-manager", TestSecurityManager.class.getName())
				...
				.withGemFireProperty(GemFireCluster.ALL_GLOB, "security-username", TestSecurityManager.SECURITY_USERNAME)
				.withGemFireProperty(GemFireCluster.ALL_GLOB, "security-password", TestSecurityManager.SECURITY_PASSWORD);
	...
	public void clientAuthenticatesWithServer() {
		...
		Assertions.assertThat(this.echoTemplate.<String, String> get("Hello")).isEqualTo("Hello");
		Assertions.assertThat(this.echoTemplate.<String, String> get("TEST")).isEqualTo("TEST");
		Assertions.assertThat(this.echoTemplate.<String, String> get("Good-Bye")).isEqualTo("Good-Bye");
	}

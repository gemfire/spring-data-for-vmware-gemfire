...
public class LoggingConfigurationIntegrationTests extends SpringApplicationContextIntegrationTestsSupport {
	...
	private void assertGemFireCacheLogLevelAndLogFile(String logLevel, String logFile) {
		...
		Assertions.assertThat(distributedSystemProperties.getProperty(GemFireProperties.LOG_LEVEL.getName())).isEqualTo(logLevel);
		Assertions.assertThat(distributedSystemProperties.getProperty(GemFireProperties.LOG_FILE.getName())).isEqualTo(logFile);
	}

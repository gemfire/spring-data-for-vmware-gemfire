...
/**
 * Constructs an {@link GudExecution} using {@link GudFunctionService#onServer(GudRegionService)}.
 *
...
class OnServerUsingRegionServiceFunctionExecution extends AbstractFunctionExecution {
	...
	OnServerUsingRegionServiceFunctionExecution(GudRegionService regionService) {
	...
	protected GudExecution getExecution() {
		return GudFunctionService.onServer(getRegionService());
	}
}

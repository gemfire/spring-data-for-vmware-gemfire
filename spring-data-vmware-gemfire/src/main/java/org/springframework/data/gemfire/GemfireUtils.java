...
/**
 * {@link GemfireUtils} is an abstract utility class encapsulating common functionality for
 * accessing features and capabilities of Apache Geode based on version as well as other
...
public abstract class GemfireUtils extends RegionUtils {
  ...
  public static boolean isGemfireFeatureAvailable(GemfireFeature feature) {
    ...
    boolean featureAvailable =
        (!GemfireFeature.AEQ.equals(feature) || isAsyncEventQueueAvailable());

    featureAvailable &=
        (!GemfireFeature.CONTINUOUS_QUERY.equals(feature) || isContinuousQueryAvailable());

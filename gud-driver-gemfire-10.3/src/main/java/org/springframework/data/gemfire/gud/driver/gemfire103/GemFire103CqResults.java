 ...
 */
public class GemFire103CqResults<E> implements GudCqResults<E>, NativeWrapper<CqResults<E>> {

    private final CqResults<E> nativeResults;

    public GemFire103CqResults(CqResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        return new GemFire103CollectionType(nativeResults.getCollectionType());
    }

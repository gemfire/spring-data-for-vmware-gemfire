 ...
 */
public class GemFireCacheTransactionManager implements GudCacheTransactionManager, NativeWrapper<CacheTransactionManager> {

    private final CacheTransactionManager nativeManager;

    public GemFireCacheTransactionManager(CacheTransactionManager nativeManager) {
    ...
    public GudTransactionId suspend() {
        ...
        return txId != null ? new GemFireTransactionId(txId) : null;
    }
    ...
    public GudTransactionWriter getWriter() {
        ...
        return writer != null ? new GemFireTransactionWriterWrapper(writer) : null;
    }
    ...
    public GudTransactionListener[] getListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFireTransactionListenerWrapper(listeners[i]);
        }
        return result;
    }
    ...
    public GudTransactionListener setListener(GudTransactionListener listener) {
        if (listener instanceof NativeWrapper) {
            ...
            return old != null ? new GemFireTransactionListenerWrapper(old) : null;
        }
        return null;
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 PartitionResolver wrapper
 */
 ...
 */
public class GemFire103PartitionResolverWrapper<K, V> implements GudPartitionResolver<K, V>, NativeWrapper<PartitionResolver<K, V>> {

    private final PartitionResolver<K, V> nativeResolver;

    public GemFire103PartitionResolverWrapper(PartitionResolver<K, V> nativeResolver) {

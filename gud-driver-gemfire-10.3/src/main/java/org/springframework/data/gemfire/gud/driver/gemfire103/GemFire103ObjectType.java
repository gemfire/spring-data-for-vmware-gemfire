 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 ObjectType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 ObjectType.
 */
public class GemFire103ObjectType implements GudObjectType, NativeWrapper<ObjectType> {

    private final ObjectType nativeType;

    public GemFire103ObjectType(ObjectType nativeType) {

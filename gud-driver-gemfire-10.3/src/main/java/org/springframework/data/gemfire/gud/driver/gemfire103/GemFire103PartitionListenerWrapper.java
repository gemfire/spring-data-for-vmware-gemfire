 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 PartitionListener wrapper
 */
 ...
 */
public class GemFire103PartitionListenerWrapper implements GudPartitionListener, NativeWrapper<PartitionListener> {

    private final PartitionListener nativeListener;

    public GemFire103PartitionListenerWrapper(PartitionListener nativeListener) {

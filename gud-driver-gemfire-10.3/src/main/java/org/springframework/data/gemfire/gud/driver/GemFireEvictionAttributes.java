 ...
 */
public class GemFireEvictionAttributes implements GudEvictionAttributes, NativeWrapper<EvictionAttributes> {

    private final EvictionAttributes nativeAttributes;

    public GemFireEvictionAttributes(EvictionAttributes nativeAttributes) {
    ...
    public GudObjectSizer getObjectSizer() {
        ...
        return sizer != null ? new GemFireObjectSizerWrapper(sizer) : null;
    }
}

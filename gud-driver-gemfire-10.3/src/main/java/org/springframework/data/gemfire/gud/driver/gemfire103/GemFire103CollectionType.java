 ...
 */
public class GemFire103CollectionType implements GudCollectionType, NativeWrapper<CollectionType> {

    private final CollectionType nativeType;

    public GemFire103CollectionType(CollectionType nativeType) {
    ...
    public GudObjectType getElementType() {
        return new GemFire103ObjectType(nativeType.getElementType());
    }

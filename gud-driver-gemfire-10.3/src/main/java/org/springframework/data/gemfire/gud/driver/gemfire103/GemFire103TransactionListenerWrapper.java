 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 TransactionListener wrapper
 */
 ...
 */
public class GemFire103TransactionListenerWrapper implements GudTransactionListener, NativeWrapper<TransactionListener> {

    private final TransactionListener nativeListener;

    public GemFire103TransactionListenerWrapper(TransactionListener nativeListener) {

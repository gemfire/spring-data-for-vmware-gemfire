 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 TransactionWriter wrapper
 */
 ...
 */
public class GemFire103TransactionWriterWrapper implements GudTransactionWriter, NativeWrapper<TransactionWriter> {

    private final TransactionWriter nativeWriter;

    public GemFire103TransactionWriterWrapper(TransactionWriter nativeWriter) {

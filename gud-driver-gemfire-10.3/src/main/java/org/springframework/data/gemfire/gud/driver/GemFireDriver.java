 ...
 * 2026-03-31: Added SERVER_REGION_NAME capability
 * 2026-04-02: Updated imports — GudCapability/GudApiVersion moved to gud-api; added
 *             DISK_STORE_SEGMENTS to capability set (present since 10.1); added
 *             createJndiBinding() and createPoolManager() methods
...
public class GemFireDriver implements GudDriver {
    ...
    private static final Set<GudCapability> SUPPORTED_CAPABILITIES = Collections.unmodifiableSet(
        EnumSet.of(
            ...
            GudCapability.SERVER_REGION_NAME
        )
    );

 ...
 */
public class GemFire103ClientCacheFactory implements GudClientCacheFactory {

    private final ClientCacheFactory nativeFactory;

    public GemFire103ClientCacheFactory() {
        this.nativeFactory = new ClientCacheFactory();
    }

    public GemFire103ClientCacheFactory(Properties properties) {
    ...
    public GudClientCache create() {
        return new GemFire103ClientCache(nativeFactory.create());
    }
    ...
    public GudClientCache getAnyInstance() {
        try {
            ...
            return new GemFire103ClientCache(nativeCache);

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 CacheFactory implementation
 */
...
/**
 * GemFire 10.3 implementation of GudCacheFactory.
 * Wraps the native CacheFactory and delegates all operations.
 */
public class GemFire103CacheFactory implements GudCacheFactory {

    private final CacheFactory nativeFactory;

    public GemFire103CacheFactory() {
    ...
    public GudCache create() {
        return new GemFire103Cache(nativeFactory.create());
    }
}

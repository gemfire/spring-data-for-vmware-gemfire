 ...
 */
public class GemFire103ClientRegionFactory<K, V> implements GudClientRegionFactory<K, V>, NativeWrapper<ClientRegionFactory<K, V>> {

    private final ClientRegionFactory<K, V> nativeFactory;

    public GemFire103ClientRegionFactory(ClientRegionFactory<K, V> nativeFactory) {
    ...
    public GudRegion<K, V> create(String regionName) {
        return new GemFire103Region<>(nativeFactory.create(regionName));
    }
    ...
    public GudRegion<K, V> createSubregion(GudRegion<?, ?> parent, String subregionName) {
        if (parent instanceof NativeWrapper) {
            ...
            return new GemFire103Region<>(nativeFactory.createSubregion(nativeParent, subregionName));
        }

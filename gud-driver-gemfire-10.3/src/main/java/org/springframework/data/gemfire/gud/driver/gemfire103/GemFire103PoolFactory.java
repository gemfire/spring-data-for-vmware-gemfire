...
/**
 * GUD API adapter for GemFire 10.3 PoolFactory.
 */
public class GemFire103PoolFactory implements GudPoolFactory, NativeWrapper<PoolFactory> {

    private final PoolFactory nativeFactory;

    public GemFire103PoolFactory(PoolFactory nativeFactory) {
    ...
    public GudPoolFactory setThreadLocalConnections(boolean threadLocalConnections) {
        // setThreadLocalConnections is deprecated/removed in 10.3
        return this;
    }
    ...
    public GudPool create(String name) {
        return new GemFire103Pool(nativeFactory.create(name));
    }
}

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 RegionEvent wrapper
 */
...
/**
 * GemFire 10.3 implementation of GudRegionEvent.
 * Wraps the native RegionEvent and delegates all operations.
 *
 * @param <K> the key type
 * @param <V> the value type
 */
public class GemFire103RegionEvent<K, V> implements GudRegionEvent<K, V>, NativeWrapper<RegionEvent<K, V>> {

    private final RegionEvent<K, V> nativeEvent;

    public GemFire103RegionEvent(RegionEvent<K, V> nativeEvent) {

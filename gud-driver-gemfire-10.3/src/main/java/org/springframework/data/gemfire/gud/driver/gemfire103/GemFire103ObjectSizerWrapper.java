 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 ObjectSizer wrapper
 */
 ...
 */
public class GemFire103ObjectSizerWrapper implements GudObjectSizer, NativeWrapper<ObjectSizer> {

    private final ObjectSizer nativeSizer;

    public GemFire103ObjectSizerWrapper(ObjectSizer nativeSizer) {

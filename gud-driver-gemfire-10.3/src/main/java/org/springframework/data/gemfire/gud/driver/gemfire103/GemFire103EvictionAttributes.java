 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 EvictionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 EvictionAttributes.
 */
public class GemFire103EvictionAttributes implements GudEvictionAttributes, NativeWrapper<EvictionAttributes> {

    private final EvictionAttributes nativeAttributes;

    public GemFire103EvictionAttributes(EvictionAttributes nativeAttributes) {
    ...
    public GudObjectSizer getObjectSizer() {
        ...
        return sizer != null ? new GemFire103ObjectSizerWrapper(sizer) : null;
    }
}

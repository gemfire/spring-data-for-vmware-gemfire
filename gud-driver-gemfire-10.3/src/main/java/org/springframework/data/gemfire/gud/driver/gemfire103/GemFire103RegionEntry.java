 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 RegionEntry adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 Region.Entry.
 *
 * @param <K> the key type
 * @param <V> the value type
 */
public class GemFire103RegionEntry<K, V> implements GudRegionEntry<K, V>, NativeWrapper<Region.Entry<K, V>> {

    private final Region.Entry<K, V> nativeEntry;

    public GemFire103RegionEntry(Region.Entry<K, V> nativeEntry) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFire103Region<>(nativeEntry.getRegion());
    }

    @Override
    public GudCacheStatistics getStatistics() {
        return new GemFire103CacheStatistics(nativeEntry.getStatistics());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFire103RegionEntry) {
            return nativeEntry.equals(((GemFire103RegionEntry<?, ?>) obj).nativeEntry);
        }
        return false;
    }

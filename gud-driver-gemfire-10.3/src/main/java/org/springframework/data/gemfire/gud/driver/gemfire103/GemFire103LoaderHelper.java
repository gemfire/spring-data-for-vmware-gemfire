 ...
 */
public class GemFire103LoaderHelper<K, V> implements GudLoaderHelper<K, V> {

    private final LoaderHelper<K, V> nativeHelper;

    public GemFire103LoaderHelper(LoaderHelper<K, V> nativeHelper) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFire103Region<>(nativeHelper.getRegion());
    }

 ...
 */
public class GemFireEntryEvent<K, V> implements GudEntryEvent<K, V>, NativeWrapper<EntryEvent<K, V>> {

    private final EntryEvent<K, V> nativeEvent;

    public GemFireEntryEvent(EntryEvent<K, V> nativeEvent) {
    ...
    public GudTransactionId getTransactionId() {
        return nativeEvent.getTransactionId() != null 
            ? new GemFireTransactionId(nativeEvent.getTransactionId()) 
            : null;
    }

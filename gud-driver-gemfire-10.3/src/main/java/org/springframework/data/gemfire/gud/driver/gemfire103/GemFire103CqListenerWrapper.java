 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 CqListener wrapper
 */
 ...
 */
public class GemFire103CqListenerWrapper implements GudCqListener, NativeWrapper<CqListener> {

    private final CqListener nativeListener;

    public GemFire103CqListenerWrapper(CqListener nativeListener) {

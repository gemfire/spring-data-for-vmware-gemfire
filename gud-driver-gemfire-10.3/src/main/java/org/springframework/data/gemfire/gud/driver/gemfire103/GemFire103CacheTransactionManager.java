 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 CacheTransactionManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 CacheTransactionManager.
 */
public class GemFire103CacheTransactionManager implements GudCacheTransactionManager, NativeWrapper<CacheTransactionManager> {

    private final CacheTransactionManager nativeManager;

    public GemFire103CacheTransactionManager(CacheTransactionManager nativeManager) {
    ...
    public GudTransactionId suspend() {
        ...
        return txId != null ? new GemFire103TransactionId(txId) : null;
    }
    ...
    public GudTransactionWriter getWriter() {
        ...
        return writer != null ? new GemFire103TransactionWriterWrapper(writer) : null;
    }
    ...
    public GudTransactionListener[] getListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFire103TransactionListenerWrapper(listeners[i]);
        }
        return result;
    }
    ...
    public GudTransactionListener setListener(GudTransactionListener listener) {
        if (listener instanceof NativeWrapper) {
            ...
            return old != null ? new GemFire103TransactionListenerWrapper(old) : null;
        }
        return null;
    }

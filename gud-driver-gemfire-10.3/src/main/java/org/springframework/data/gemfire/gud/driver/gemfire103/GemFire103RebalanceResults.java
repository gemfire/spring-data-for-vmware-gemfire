 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 RebalanceResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 RebalanceResults.
 */
public class GemFire103RebalanceResults implements GudRebalanceResults, NativeWrapper<RebalanceResults> {

    private final RebalanceResults nativeResults;

    public GemFire103RebalanceResults(RebalanceResults nativeResults) {
    ...
    public Set<GudPartitionRebalanceInfo> getPartitionRebalanceDetails() {
        return nativeResults.getPartitionRebalanceDetails().stream()
            .map(GemFire103PartitionRebalanceInfo::new)

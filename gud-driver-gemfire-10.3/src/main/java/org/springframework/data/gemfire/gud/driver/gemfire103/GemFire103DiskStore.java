 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 DiskStore adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 DiskStore.
 */
public class GemFire103DiskStore implements GudDiskStore, NativeWrapper<DiskStore> {

    private final DiskStore nativeDiskStore;

    public GemFire103DiskStore(DiskStore nativeDiskStore) {
    ...
    public int[] getSegments() {
        // GemFire 10.3 may not have getSegments - return default
        return new int[]{1};
    }
}

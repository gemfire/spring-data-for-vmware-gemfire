 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 Execution adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 Execution.
 *
...
public class GemFire103Execution<IN, OUT, AGG> implements GudExecution<IN, OUT, AGG>, NativeWrapper<Execution> {

    private Execution nativeExecution;

    public GemFire103Execution(Execution nativeExecution) {
    ...
    public GudResultCollector<OUT, AGG> execute(String functionId) {
        ...
        return new GemFire103ResultCollector<>(result);
    }

 ...
 */
public class GemFireIndexStatistics implements GudIndexStatistics, NativeWrapper<IndexStatistics> {

    private final IndexStatistics nativeStatistics;

    public GemFireIndexStatistics(IndexStatistics nativeStatistics) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 DiskStoreFactory adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 DiskStoreFactory.
 */
public class GemFire103DiskStoreFactory implements GudDiskStoreFactory, NativeWrapper<DiskStoreFactory> {

    private final DiskStoreFactory nativeFactory;

    public GemFire103DiskStoreFactory(DiskStoreFactory nativeFactory) {
    ...
    public GudDiskStoreFactory setSegments(int segments) {
        // GemFire 10.3 may not have setSegments - ignore
        return this;
    }

    @Override
    public GudDiskStore create(String name) {
        return new GemFire103DiskStore(nativeFactory.create(name));
    }
}

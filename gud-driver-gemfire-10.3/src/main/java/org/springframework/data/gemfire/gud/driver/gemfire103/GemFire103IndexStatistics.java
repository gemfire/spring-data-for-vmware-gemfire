 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 IndexStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 IndexStatistics.
 */
public class GemFire103IndexStatistics implements GudIndexStatistics, NativeWrapper<IndexStatistics> {

    private final IndexStatistics nativeStatistics;

    public GemFire103IndexStatistics(IndexStatistics nativeStatistics) {

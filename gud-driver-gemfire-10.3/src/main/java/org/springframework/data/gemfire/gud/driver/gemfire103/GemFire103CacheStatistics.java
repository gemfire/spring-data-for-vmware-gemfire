 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 CacheStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 CacheStatistics.
 */
public class GemFire103CacheStatistics implements GudCacheStatistics, NativeWrapper<CacheStatistics> {

    private final CacheStatistics nativeStatistics;

    public GemFire103CacheStatistics(CacheStatistics nativeStatistics) {

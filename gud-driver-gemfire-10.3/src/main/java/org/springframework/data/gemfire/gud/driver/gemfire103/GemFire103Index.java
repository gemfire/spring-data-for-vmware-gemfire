 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 Index adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 Index.
 */
public class GemFire103Index implements GudIndex, NativeWrapper<Index> {

    private final Index nativeIndex;

    public GemFire103Index(Index nativeIndex) {
    ...
    public GudRegion<?, ?> getRegion() {
        return new GemFire103Region<>(nativeIndex.getRegion());
    }

    @Override
    public GudIndexStatistics getStatistics() {
        return new GemFire103IndexStatistics(nativeIndex.getStatistics());
    }
}

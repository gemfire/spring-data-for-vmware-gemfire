 ...
 */
public class GemFire103SelectResults<E> implements GudSelectResults<E>, NativeWrapper<SelectResults<E>> {

    private final SelectResults<E> nativeResults;

    public GemFire103SelectResults(SelectResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        ...
        return new GemFire103CollectionType(type);
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.3 CqStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.3 CqStatistics.
 */
public class GemFire103CqStatistics implements GudCqStatistics, NativeWrapper<CqStatistics> {

    private final CqStatistics nativeStatistics;

    public GemFire103CqStatistics(CqStatistics nativeStatistics) {

...
publishingDetails {
    ...
    longName.set("Spring Test Framework for VMware GemFire ${getGemFireBaseVersion()} and Spring Data 2.6")
    description.set("Spring Test Framework for VMware GemFire ${getGemFireBaseVersion()} and Spring Data 2.6")
    test.set(true)
}

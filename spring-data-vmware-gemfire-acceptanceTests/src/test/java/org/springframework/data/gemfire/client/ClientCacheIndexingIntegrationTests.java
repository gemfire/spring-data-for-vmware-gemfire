...
public class ClientCacheIndexingIntegrationTests {
	...
	public void testIndexByName() {
		...
		Assertions.assertThat(clientCache)
		...
		Assertions.assertThat(actualIndex).isNotNull();
		Assertions.assertThat(actualIndex.getName()).isEqualTo("ExampleIndex");
		Assertions.assertThat(actualIndex.getType()).isEqualTo(IndexType.HASH);
		Assertions.assertThat(actualIndex).isSameAs(exampleIndex);
	}
}

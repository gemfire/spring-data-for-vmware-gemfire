...
public class PdxDiskStoreIntegrationTests extends IntegrationTestsSupport {
	...
	public static void setupBeforeClass() {
		...
		Assertions.assertThat(IntegrationTestsSupport.createDirectory(createFile("./gemfire/data-store")).isDirectory()).isTrue();
		Assertions.assertThat(IntegrationTestsSupport.createDirectory(createFile("./gemfire/pdx-store")).isDirectory()).isTrue();
	}
	...
	public void setup() {
		...
		Assertions.assertThat(pdxDataRegion).as("The PdxData GemFire Region was not created successfully").isNotNull();
	...
	public void testPersistentRegionWithDataCreation() {
		...
		Assertions.assertThat(pdxDataRegion.size()).isEqualTo(NUMBER_OF_REGION_ENTRIES);
	}

...
public class ClientSubRegionIntegrationTests {
	...
	public void gemFireSubRegionCreationConfigurationIsCorrect() {
		...
		Assertions.assertThat(this.clientCache)
		...
		Assertions.assertThat(child).isSameAs(clientCacheChild);
	}
	...
	public void templateCreationConfigurationIsCorrect() {
		...
		Assertions.assertThat(this.parentTemplate).isNotNull();
		Assertions.assertThat(this.parentTemplate.getRegion()).isSameAs(this.parent);
		Assertions.assertThat(this.childTemplate).isNotNull();
		Assertions.assertThat(this.childTemplate.getRegion()).isSameAs(this.child);
	}
}

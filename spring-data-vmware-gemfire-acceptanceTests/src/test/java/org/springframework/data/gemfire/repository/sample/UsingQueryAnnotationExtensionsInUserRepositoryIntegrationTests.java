...
public class UsingQueryAnnotationExtensionsInUserRepositoryIntegrationTests extends IntegrationTestsSupport {
	...
	public void setup() {
		...
		if (users.isEmpty()) {
			...
			Assertions.assertThat(users.size()).isEqualTo(8);
		}
	}
	...
	public void queryUsingFindBy() {
		...
		Assertions.assertThat(users.get(0)).isEqualTo(create("janeDoe"));
	}
	...
	public void queryUsingFindByUsernameOrderedAndLimited() {
		...
		Assertions.assertThat(users).isEqualTo(users("cookieDoe", "froDoe", "joeDoe", "jonDoe", "sourDoe"));
	}
	...
	public void queryUsingFindByUsernameOrderedAndUnderLimit() {
		...
		Assertions.assertThat(users.isEmpty()).isFalse();
		Assertions.assertThat(users.size()).isEqualTo(1);
		Assertions.assertThat(users.get(0)).isEqualTo(create("cookieDoe"));
	}
}

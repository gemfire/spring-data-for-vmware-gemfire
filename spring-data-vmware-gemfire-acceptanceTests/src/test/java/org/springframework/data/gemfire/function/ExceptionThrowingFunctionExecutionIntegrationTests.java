...
public class ExceptionThrowingFunctionExecutionIntegrationTests extends ForkingClientServerIntegrationTestsSupport {
	...
	public static void startGeodeServer() throws IOException {
		ForkingClientServerIntegrationTestsSupport.startGemFireServer(ServerProcess.class,
			IntegrationTestsSupport.getServerContextXmlFileLocation(ExceptionThrowingFunctionExecutionIntegrationTests.class));
	}
	...
	public void exceptionThrowingFunctionExecutionRethrowsException() {
		...
		try {
			...
			Assertions.assertThat(expected).hasMessage("Execution of Function [with ID [exceptionThrowingFunction]] failed");
			Assertions.assertThat(expected).hasCauseInstanceOf(IllegalArgumentException.class);
			Assertions.assertThat(expected.getCause()).hasMessage("TEST");

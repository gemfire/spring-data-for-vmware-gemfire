...
public abstract class AbstractTransactionalEventListenerIntegrationTests extends IntegrationTestsSupport {
	...
	public void successfulEntityTransactionTriggersCommitTransactionEvents() throws Exception {
		...
		Assertions.assertThat(jonDoeLoaded).isEqualTo(jonDoe);
	...
	public void failingEntityTransactionTriggersRollbackTransactionEvent() throws Exception {
		...
		try {
			...
			try {
				...
				Assertions.assertThat(alsoExpected).hasMessage("No Customer having ID [2] was found");
				Assertions.assertThat(alsoExpected).hasNoCause();
	...
	public static class CustomerService {
		...
		public Customer findById(Long id) {
			return this.customerRepository.findById(id)
				.orElseThrow(() -> RuntimeExceptionFactory.newIllegalStateException("No Customer having ID [%d] was found", id));
		}
		...
		public Customer saveFailsAndRollsback(Customer customer) {
			...
			throw RuntimeExceptionFactory.newIllegalStateException("TEST");
		}
	}

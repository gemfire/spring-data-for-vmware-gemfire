...
public class RepositoryQueriesWithJoinsIntegrationTest extends IntegrationTestsSupport {
	...
	public void joinQueriesWork() {
		...
		Assertions.assertThat(actualCustomersWithAccounts).isNotNull();
		Assertions.assertThat(actualCustomersWithAccounts).hasSize(2);
		Assertions.assertThat(actualCustomersWithAccounts).containsAll(expectedCustomersWithAccounts);
	}
}

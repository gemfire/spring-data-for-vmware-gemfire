...
public class EnableGemfireCachingIntegrationTests extends IntegrationTestsSupport {
	...
	public void gemfireCacheManagerIsConfigured() {
		Assertions.assertThat(this.gemfireCacheManager).isNotNull();
	}

	@Test
	public void enableGemfireCachingIsSuccessful() {

		Assertions.assertThat(calculator.isCacheMiss()).isFalse();
		Assertions.assertThat(calculator.factorial(0L)).isEqualTo(1L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
		Assertions.assertThat(calculator.factorial(1L)).isEqualTo(1L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
		Assertions.assertThat(calculator.factorial(2L)).isEqualTo(2L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
		Assertions.assertThat(calculator.factorial(0L)).isEqualTo(1L);
		Assertions.assertThat(calculator.isCacheMiss()).isFalse();
		Assertions.assertThat(calculator.factorial(1L)).isEqualTo(1L);
		...
		Assertions.assertThat(calculator.factorial(2L)).isEqualTo(2L);
		Assertions.assertThat(calculator.isCacheMiss()).isFalse();
		Assertions.assertThat(calculator.factorial(3L)).isEqualTo(6L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
		Assertions.assertThat(calculator.factorial(4L)).isEqualTo(24L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
		Assertions.assertThat(calculator.factorial(5L)).isEqualTo(120L);
		Assertions.assertThat(calculator.isCacheMiss()).isTrue();
	}

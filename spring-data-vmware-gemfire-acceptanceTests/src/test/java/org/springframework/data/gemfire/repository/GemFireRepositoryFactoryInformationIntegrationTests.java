...
public class GemFireRepositoryFactoryInformationIntegrationTests extends IntegrationTestsSupport {
	...
	public void applicationContextContainsUserRepositoryBean() {
		Assertions.assertThat(this.applicationContext.getBeanNamesForType(UserRepository.class)).contains("userRepository");
	}
	...
	public void canGetGemfireRepositoryBeansByRepositoryFactoryInformationType() {
		...
		Assertions.assertThat(repositoryFactories).isNotNull();
		Assertions.assertThat(repositoryFactories).isNotEmpty();
		Assertions.assertThat(repositoryFactories).containsKeys("&userRepository");
		Assertions.assertThat(repositoryFactories.get("&userRepository")).isInstanceOf(GemfireRepositoryFactoryBean.class);
	}

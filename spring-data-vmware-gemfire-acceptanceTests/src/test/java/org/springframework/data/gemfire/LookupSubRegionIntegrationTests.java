...
public class LookupSubRegionIntegrationTests extends IntegrationTestsSupport {
	...
	private void assertRegionExists(String expectedRegionName, String expectedRegionPath, Region<?, ?> region) {
		...
		Assertions.assertThat(region.getFullPath())
	...
	public void testDirectLookup() {
		...
		Assertions.assertThat(applicationContext.containsBean("Customers/Accounts")).isFalse();
		Assertions.assertThat(applicationContext.containsBean("/Customers")).isFalse();
		Assertions.assertThat(applicationContext.containsBean("Customers")).isFalse();
		...
		Assertions.assertThat(applicationContext.containsBean("/Customers/Accounts/Orders/Items")).isFalse();
		Assertions.assertThat(applicationContext.containsBean("/Customers/Accounts/Orders")).isFalse();
		Assertions.assertThat(applicationContext.containsBean("Customers/Accounts/Orders")).isFalse();
	}
	...
	public void testNestedLookup() {
		...
		Assertions.assertThat(applicationContext.containsBean("/Parent")).isFalse();

		Region<?, ?> child = applicationContext.getBean("/Parent/Child", Region.class);

		assertRegionExists("Child", "/Parent/Child", child);
		Assertions.assertThat(applicationContext.containsBean("Parent/Child")).isFalse();
		...
		Assertions.assertThat(applicationContext.containsBean("Parent/Child/Grandchild")).isFalse();
	}
}

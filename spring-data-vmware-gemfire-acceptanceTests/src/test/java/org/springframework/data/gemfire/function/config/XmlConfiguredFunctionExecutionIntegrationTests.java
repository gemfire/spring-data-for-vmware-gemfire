...
public class XmlConfiguredFunctionExecutionIntegrationTests extends IntegrationTestsSupport {
	...
	public void testProxyFactoryBeanCreated() throws Exception {
		...
		Assertions.assertThat(TestOnRegionFunction.class).isEqualTo(serviceInterface);
		...
		Assertions.assertThat(TestUtils.<Object>readField("region", template)).isSameAs(regionOne);
	}
}

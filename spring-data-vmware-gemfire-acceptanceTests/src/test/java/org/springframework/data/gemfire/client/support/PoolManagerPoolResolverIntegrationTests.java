...
public class PoolManagerPoolResolverIntegrationTests extends IntegrationTestsSupport {
	...
	public void setup() {
		...
		Assertions.assertThat(this.clientCache.getName()).isEqualTo(PoolManagerPoolResolverIntegrationTests.class.getSimpleName());
		Assertions.assertThat(this.carPool).isNotNull();
		Assertions.assertThat(this.carPool.getName()).isEqualTo("CarPool");
		Assertions.assertThat(this.swimmingPool).isNotNull();
		Assertions.assertThat(this.swimmingPool.getName()).isEqualTo("SwimmingPool");

		this.defaultPool = this.clientCache.getDefaultPool();

		Assertions.assertThat(this.defaultPool).isNotNull();
		Assertions.assertThat(this.defaultPool).isNotSameAs(this.carPool);
		Assertions.assertThat(this.defaultPool).isNotSameAs(this.swimmingPool);
	}

	@Test
	public void resolvePoolFromName() {

		Assertions.assertThat(this.poolResolver.resolve("DEFAULT")).isEqualTo(this.defaultPool);
		Assertions.assertThat(this.poolResolver.resolve("CarPool")).isEqualTo(this.carPool);
		Assertions.assertThat(this.poolResolver.resolve("SwimmingPool")).isEqualTo(this.swimmingPool);
	}

	@Test
	public void resolvePoolFromBlankPoolNameReturnsNull() {
		Assertions.assertThat(this.poolResolver.resolve("  ")).isNull();
	}
	...
	public void resolvePoolFromNullPoolNameReturnsNull() {
		Assertions.assertThat(this.poolResolver.resolve((String) null)).isNull();
	}

	@Test
	public void resolvePoolFromRegion() {

		Assertions.assertThat(this.poolResolver.resolve(this.regionWithDefaultPool)).isEqualTo(this.defaultPool);
		Assertions.assertThat(this.poolResolver.resolve(this.regionWithSwimmingPool)).isEqualTo(this.swimmingPool);
	}

	@Test
	public void resolvePoolFromNullRegionIsNullSafeAndReturnsNull() {
		Assertions.assertThat(this.poolResolver.resolve((Region<?, ?>) null)).isNull();
	}

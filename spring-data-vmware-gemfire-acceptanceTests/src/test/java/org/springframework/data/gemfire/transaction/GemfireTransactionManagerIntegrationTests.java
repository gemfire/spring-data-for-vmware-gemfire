...
public class GemfireTransactionManagerIntegrationTests extends IntegrationTestsSupport {
	...
	public void suspendAndResumeIsSuccessful() {
		...
		try {
			...
			Assertions.assertThat(expected).hasMessage("BOOM");
			...
			Assertions.assertThat(this.example.containsKey("tx-1-op-1")).isFalse();
			Assertions.assertThat(this.example.containsKey("tx-2-op-1")).isTrue();
		}
	}

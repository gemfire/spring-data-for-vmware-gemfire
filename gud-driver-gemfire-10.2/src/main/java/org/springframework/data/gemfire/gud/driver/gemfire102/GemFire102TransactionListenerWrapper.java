 ...
 */
public class GemFire102TransactionListenerWrapper implements GudTransactionListener, NativeWrapper<TransactionListener> {

    private final TransactionListener nativeListener;

    public GemFire102TransactionListenerWrapper(TransactionListener nativeListener) {

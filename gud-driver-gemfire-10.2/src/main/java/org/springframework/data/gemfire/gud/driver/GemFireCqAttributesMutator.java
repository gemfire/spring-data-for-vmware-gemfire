 ...
 */
public class GemFireCqAttributesMutator implements GudCqAttributesMutator, NativeWrapper<CqAttributesMutator> {

    private final CqAttributesMutator nativeMutator;

    public GemFireCqAttributesMutator(CqAttributesMutator nativeMutator) {

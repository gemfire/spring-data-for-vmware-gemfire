 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 PartitionRebalanceInfo adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 PartitionRebalanceInfo.
 */
public class GemFire102PartitionRebalanceInfo implements GudPartitionRebalanceInfo, NativeWrapper<PartitionRebalanceInfo> {

    private final PartitionRebalanceInfo nativeInfo;

    public GemFire102PartitionRebalanceInfo(PartitionRebalanceInfo nativeInfo) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 ResourceManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 ResourceManager.
 */
public class GemFire102ResourceManager implements GudResourceManager, NativeWrapper<ResourceManager> {

    private final ResourceManager nativeManager;

    public GemFire102ResourceManager(ResourceManager nativeManager) {
    ...
    public GudRebalanceFactory createRebalanceFactory() {
        return new GemFire102RebalanceFactory(nativeManager.createRebalanceFactory());
    }

 ...
 * Description:
 * 2026-03-11: Created GemFire 10.2 Pool adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 Pool.
 */
public class GemFire102Pool implements GudPool, NativeWrapper<Pool> {

    private final Pool nativePool;

    public GemFire102Pool(Pool nativePool) {
    ...
    public GudQueryService getQueryService() {
        return new GemFire102QueryService(nativePool.getQueryService());
    }

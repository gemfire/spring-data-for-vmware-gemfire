 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 ObjectSizer wrapper
 */
 ...
 */
public class GemFire102ObjectSizerWrapper implements GudObjectSizer, NativeWrapper<ObjectSizer> {

    private final ObjectSizer nativeSizer;

    public GemFire102ObjectSizerWrapper(ObjectSizer nativeSizer) {

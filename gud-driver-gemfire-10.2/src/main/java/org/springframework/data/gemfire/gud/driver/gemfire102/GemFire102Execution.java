...
public class GemFire102Execution<IN, OUT, AGG> implements GudExecution<IN, OUT, AGG>, NativeWrapper<Execution> {

    private Execution nativeExecution;

    public GemFire102Execution(Execution nativeExecution) {
    ...
    public GudResultCollector<OUT, AGG> execute(String functionId) {
        ...
        return new GemFire102ResultCollector<>(result);
    }

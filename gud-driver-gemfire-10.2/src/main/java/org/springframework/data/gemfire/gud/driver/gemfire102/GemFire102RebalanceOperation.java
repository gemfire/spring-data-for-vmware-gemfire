 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 RebalanceOperation adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 RebalanceOperation.
 */
public class GemFire102RebalanceOperation implements GudRebalanceOperation, NativeWrapper<RebalanceOperation> {

    private final RebalanceOperation nativeOperation;

    public GemFire102RebalanceOperation(RebalanceOperation nativeOperation) {
    ...
    public GudRebalanceResults getResults() throws CancellationException, InterruptedException {
        return new GemFire102RebalanceResults(nativeOperation.getResults());
    }

    @Override
    public GudRebalanceResults getResults(long timeout, TimeUnit unit) throws InterruptedException {
        try {
            return new GemFire102RebalanceResults(nativeOperation.getResults(timeout, unit));

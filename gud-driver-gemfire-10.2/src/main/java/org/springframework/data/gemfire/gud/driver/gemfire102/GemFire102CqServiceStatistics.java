 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqServiceStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqServiceStatistics.
 */
public class GemFire102CqServiceStatistics implements GudCqServiceStatistics, NativeWrapper<CqServiceStatistics> {

    private final CqServiceStatistics nativeStatistics;

    public GemFire102CqServiceStatistics(CqServiceStatistics nativeStatistics) {

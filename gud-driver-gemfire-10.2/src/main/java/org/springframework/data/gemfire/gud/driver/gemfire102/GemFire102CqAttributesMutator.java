 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqAttributesMutator adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqAttributesMutator.
 */
public class GemFire102CqAttributesMutator implements GudCqAttributesMutator, NativeWrapper<CqAttributesMutator> {

    private final CqAttributesMutator nativeMutator;

    public GemFire102CqAttributesMutator(CqAttributesMutator nativeMutator) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqResults.
 *
 * @param <E> the element type
 */
public class GemFire102CqResults<E> implements GudCqResults<E>, NativeWrapper<CqResults<E>> {

    private final CqResults<E> nativeResults;

    public GemFire102CqResults(CqResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        return new GemFire102CollectionType(nativeResults.getCollectionType());
    }

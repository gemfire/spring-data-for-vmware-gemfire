 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 EvictionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 EvictionAttributes.
 */
public class GemFire102EvictionAttributes implements GudEvictionAttributes, NativeWrapper<EvictionAttributes> {

    private final EvictionAttributes nativeAttributes;

    public GemFire102EvictionAttributes(EvictionAttributes nativeAttributes) {
    ...
    public GudObjectSizer getObjectSizer() {
        ...
        return sizer != null ? new GemFire102ObjectSizerWrapper(sizer) : null;
    }
}

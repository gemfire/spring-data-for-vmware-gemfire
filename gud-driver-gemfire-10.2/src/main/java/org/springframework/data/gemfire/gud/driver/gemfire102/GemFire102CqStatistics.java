 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqStatistics.
 */
public class GemFire102CqStatistics implements GudCqStatistics, NativeWrapper<CqStatistics> {

    private final CqStatistics nativeStatistics;

    public GemFire102CqStatistics(CqStatistics nativeStatistics) {

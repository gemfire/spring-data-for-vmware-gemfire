 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CacheFactory implementation
 */
...
/**
 * GemFire 10.2 implementation of GudCacheFactory.
 * Wraps the native CacheFactory and delegates all operations.
 */
public class GemFire102CacheFactory implements GudCacheFactory {

    private final CacheFactory nativeFactory;

    public GemFire102CacheFactory() {
    ...
    public GudCache create() {
        return new GemFire102Cache(nativeFactory.create());
    }
}

 ...
 */
public class GemFirePool implements GudPool, NativeWrapper<Pool> {

    private final Pool nativePool;

    public GemFirePool(Pool nativePool) {
    ...
    public GudQueryService getQueryService() {
        return new GemFireQueryService(nativePool.getQueryService());
    }

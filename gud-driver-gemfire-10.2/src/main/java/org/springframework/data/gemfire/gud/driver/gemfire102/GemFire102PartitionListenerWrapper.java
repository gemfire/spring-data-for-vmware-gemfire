 ...
 */
public class GemFire102PartitionListenerWrapper implements GudPartitionListener, NativeWrapper<PartitionListener> {

    private final PartitionListener nativeListener;

    public GemFire102PartitionListenerWrapper(PartitionListener nativeListener) {

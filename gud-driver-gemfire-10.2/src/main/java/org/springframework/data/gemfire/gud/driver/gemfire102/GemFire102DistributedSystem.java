 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 DistributedSystem adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 DistributedSystem.
 */
public class GemFire102DistributedSystem implements GudDistributedSystem, NativeWrapper<DistributedSystem> {

    private final DistributedSystem nativeSystem;

    public GemFire102DistributedSystem(DistributedSystem nativeSystem) {
    ...
    public GudDistributedMember getDistributedMember() {
        return new GemFire102DistributedMember(nativeSystem.getDistributedMember());
    }

    @Override
    public Set<GudDistributedMember> getAllOtherMembers() {
        return nativeSystem.getAllOtherMembers().stream()
            .map(GemFire102DistributedMember::new)
    ...
    public GudDistributedMember findDistributedMember(String name) {
        ...
        return member != null ? new GemFire102DistributedMember(member) : null;
    }

    @Override
    public GudDistributedMember findDistributedMemberByName(String name) {
        // In GemFire 10.2, use findDistributedMember
    ...
    public String getSystemId() {
        // GemFire 10.2 may not have getSystemId - return name
        return getName();
    }
    ...
    public GudDistributedSystem getReconnectedSystem() {
        ...
        return reconnected != null ? new GemFire102DistributedSystem(reconnected) : null;
    }
}

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 RegionFactory adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 RegionFactory.
 *
 * @param <K> the key type
 * @param <V> the value type
 */
public class GemFire102RegionFactory<K, V> implements GudRegionFactory<K, V>, NativeWrapper<RegionFactory<K, V>> {

    private final RegionFactory<K, V> nativeFactory;

    public GemFire102RegionFactory(RegionFactory<K, V> nativeFactory) {

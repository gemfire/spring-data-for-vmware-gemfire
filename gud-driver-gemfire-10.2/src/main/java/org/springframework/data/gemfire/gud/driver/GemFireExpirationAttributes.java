 ...
 */
public class GemFireExpirationAttributes implements GudExpirationAttributes, NativeWrapper<ExpirationAttributes> {

    private final ExpirationAttributes nativeAttributes;

    public GemFireExpirationAttributes(ExpirationAttributes nativeAttributes) {

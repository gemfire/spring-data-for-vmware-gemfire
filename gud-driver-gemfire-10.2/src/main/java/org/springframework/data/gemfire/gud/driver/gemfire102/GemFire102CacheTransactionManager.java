 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CacheTransactionManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CacheTransactionManager.
 */
public class GemFire102CacheTransactionManager implements GudCacheTransactionManager, NativeWrapper<CacheTransactionManager> {

    private final CacheTransactionManager nativeManager;

    public GemFire102CacheTransactionManager(CacheTransactionManager nativeManager) {
    ...
    public GudTransactionId suspend() {
        ...
        return txId != null ? new GemFire102TransactionId(txId) : null;
    }
    ...
    public GudTransactionWriter getWriter() {
        ...
        return writer != null ? new GemFire102TransactionWriterWrapper(writer) : null;
    }
    ...
    public GudTransactionListener[] getListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFire102TransactionListenerWrapper(listeners[i]);
        }
        return result;
    }
    ...
    public GudTransactionListener setListener(GudTransactionListener listener) {
        if (listener instanceof NativeWrapper) {
            ...
            return old != null ? new GemFire102TransactionListenerWrapper(old) : null;
        }
        return null;
    }

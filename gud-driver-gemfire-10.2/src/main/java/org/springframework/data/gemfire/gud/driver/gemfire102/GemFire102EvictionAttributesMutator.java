 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 EvictionAttributesMutator adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 EvictionAttributesMutator.
 */
public class GemFire102EvictionAttributesMutator implements GudEvictionAttributesMutator, NativeWrapper<EvictionAttributesMutator> {

    private final EvictionAttributesMutator nativeMutator;

    public GemFire102EvictionAttributesMutator(EvictionAttributesMutator nativeMutator) {

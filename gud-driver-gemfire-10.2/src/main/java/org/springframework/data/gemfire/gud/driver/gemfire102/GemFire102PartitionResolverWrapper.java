 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 PartitionResolver wrapper
 */
 ...
 */
public class GemFire102PartitionResolverWrapper<K, V> implements GudPartitionResolver<K, V>, NativeWrapper<PartitionResolver<K, V>> {

    private final PartitionResolver<K, V> nativeResolver;

    public GemFire102PartitionResolverWrapper(PartitionResolver<K, V> nativeResolver) {

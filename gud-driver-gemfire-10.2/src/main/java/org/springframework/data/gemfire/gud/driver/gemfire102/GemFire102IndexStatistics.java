 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 IndexStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 IndexStatistics.
 */
public class GemFire102IndexStatistics implements GudIndexStatistics, NativeWrapper<IndexStatistics> {

    private final IndexStatistics nativeStatistics;

    public GemFire102IndexStatistics(IndexStatistics nativeStatistics) {

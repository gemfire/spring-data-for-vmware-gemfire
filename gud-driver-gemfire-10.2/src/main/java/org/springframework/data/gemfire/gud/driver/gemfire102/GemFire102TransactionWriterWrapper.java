 ...
 */
public class GemFire102TransactionWriterWrapper implements GudTransactionWriter, NativeWrapper<TransactionWriter> {

    private final TransactionWriter nativeWriter;

    public GemFire102TransactionWriterWrapper(TransactionWriter nativeWriter) {

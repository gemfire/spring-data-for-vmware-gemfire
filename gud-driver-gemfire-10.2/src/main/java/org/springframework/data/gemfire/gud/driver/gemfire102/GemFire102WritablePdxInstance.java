 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 WritablePdxInstance adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 WritablePdxInstance.
 */
public class GemFire102WritablePdxInstance implements GudWritablePdxInstance, NativeWrapper<WritablePdxInstance> {

    private final WritablePdxInstance nativeInstance;

    public GemFire102WritablePdxInstance(WritablePdxInstance nativeInstance) {

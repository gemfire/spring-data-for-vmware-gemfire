 ...
 */
public class GemFire102FixedPartitionAttributes implements GudFixedPartitionAttributes, NativeWrapper<FixedPartitionAttributes> {

    private final FixedPartitionAttributes nativeAttributes;

    public GemFire102FixedPartitionAttributes(FixedPartitionAttributes nativeAttributes) {

 ...
 */
public class GemFire102QueryStatistics implements GudQueryStatistics, NativeWrapper<QueryStatistics> {

    private final QueryStatistics nativeStatistics;

    public GemFire102QueryStatistics(QueryStatistics nativeStatistics) {

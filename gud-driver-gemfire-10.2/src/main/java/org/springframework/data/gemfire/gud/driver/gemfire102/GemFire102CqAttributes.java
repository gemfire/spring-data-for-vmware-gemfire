 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqAttributes.
 */
public class GemFire102CqAttributes implements GudCqAttributes, NativeWrapper<CqAttributes> {

    private final CqAttributes nativeAttributes;

    public GemFire102CqAttributes(CqAttributes nativeAttributes) {
    ...
    public GudCqListener[] getCqListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFire102CqListenerWrapper(listeners[i]);
        }
        return result;
    }
}

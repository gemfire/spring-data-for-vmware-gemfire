 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CollectionType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CollectionType.
 */
public class GemFire102CollectionType implements GudCollectionType, NativeWrapper<CollectionType> {

    private final CollectionType nativeType;

    public GemFire102CollectionType(CollectionType nativeType) {
    ...
    public GudObjectType getElementType() {
        return new GemFire102ObjectType(nativeType.getElementType());
    }

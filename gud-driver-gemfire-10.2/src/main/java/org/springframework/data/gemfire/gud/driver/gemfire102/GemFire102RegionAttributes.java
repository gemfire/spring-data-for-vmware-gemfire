 ...
 * Description:
 * 2026-03-11: Created GemFire 10.2 RegionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 RegionAttributes.
 */
public class GemFire102RegionAttributes<K, V> implements GudRegionAttributes<K, V>, NativeWrapper<RegionAttributes<K, V>> {

    private final RegionAttributes<K, V> nativeAttributes;

    public GemFire102RegionAttributes(RegionAttributes<K, V> nativeAttributes) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 ExpirationAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 ExpirationAttributes.
 */
public class GemFire102ExpirationAttributes implements GudExpirationAttributes, NativeWrapper<ExpirationAttributes> {

    private final ExpirationAttributes nativeAttributes;

    public GemFire102ExpirationAttributes(ExpirationAttributes nativeAttributes) {

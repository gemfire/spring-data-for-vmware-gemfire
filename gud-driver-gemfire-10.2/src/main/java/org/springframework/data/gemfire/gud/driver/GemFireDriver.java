 ...
 *             set to include PER_SERVER_CONNECTION_LIMITS and DISK_STORE_SEGMENTS (both present
 *             since 10.1); added createJndiBinding() and createPoolManager() methods
 ...
 */
public class GemFireDriver implements GudDriver {
    ...
    public GudClientCacheFactory createClientCacheFactory() {
        return new GemFireClientCacheFactory();
    }

 ...
 */
public class GemFirePartitionRebalanceInfo implements GudPartitionRebalanceInfo, NativeWrapper<PartitionRebalanceInfo> {

    private final PartitionRebalanceInfo nativeInfo;

    public GemFirePartitionRebalanceInfo(PartitionRebalanceInfo nativeInfo) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 SelectResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 SelectResults.
 *
 * @param <E> the element type
 */
public class GemFire102SelectResults<E> implements GudSelectResults<E>, NativeWrapper<SelectResults<E>> {

    private final SelectResults<E> nativeResults;

    public GemFire102SelectResults(SelectResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        ...
        return new GemFire102CollectionType(type);
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqListener wrapper
 */
 ...
 */
public class GemFire102CqListenerWrapper implements GudCqListener, NativeWrapper<CqListener> {

    private final CqListener nativeListener;

    public GemFire102CqListenerWrapper(CqListener nativeListener) {

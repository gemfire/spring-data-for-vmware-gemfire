...
/**
 * GemFire 10.2 implementation of GudClientCacheFactory.
 ...
 */
public class GemFire102ClientCacheFactory implements GudClientCacheFactory {

    private final ClientCacheFactory nativeFactory;

    public GemFire102ClientCacheFactory() {
        this.nativeFactory = new ClientCacheFactory();
    }

    public GemFire102ClientCacheFactory(Properties properties) {
    ...
    public GudClientCache create() {
        return new GemFire102ClientCache(nativeFactory.create());
    }
    ...
    public GudClientCache getAnyInstance() {
        try {
            ...
            return new GemFire102ClientCache(nativeCache);

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 Index adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 Index.
 */
public class GemFire102Index implements GudIndex, NativeWrapper<Index> {

    private final Index nativeIndex;

    public GemFire102Index(Index nativeIndex) {
    ...
    public GudRegion<?, ?> getRegion() {
        return new GemFire102Region<>(nativeIndex.getRegion());
    }

    @Override
    public GudIndexStatistics getStatistics() {
        return new GemFire102IndexStatistics(nativeIndex.getStatistics());
    }
}

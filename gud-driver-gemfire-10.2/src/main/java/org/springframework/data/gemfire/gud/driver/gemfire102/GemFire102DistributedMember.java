 ...
 */
public class GemFire102DistributedMember implements GudDistributedMember, NativeWrapper<DistributedMember> {

    private final DistributedMember nativeMember;

    public GemFire102DistributedMember(DistributedMember nativeMember) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFire102DistributedMember) {
            return nativeMember.equals(((GemFire102DistributedMember) obj).nativeMember);
        }
        return false;
    }

 ...
 */
public class GemFire102Cache implements GudCache, NativeWrapper<Cache> {

    private final Cache nativeCache;

    public GemFire102Cache(Cache nativeCache) {
    ...
    public GudCache getReconnectedCache() {
        ...
        return reconnected != null ? new GemFire102Cache(reconnected) : null;
    }

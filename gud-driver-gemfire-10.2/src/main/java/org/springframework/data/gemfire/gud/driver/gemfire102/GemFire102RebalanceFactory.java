 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 RebalanceFactory adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 RebalanceFactory.
 */
public class GemFire102RebalanceFactory implements GudRebalanceFactory, NativeWrapper<RebalanceFactory> {

    private final RebalanceFactory nativeFactory;

    public GemFire102RebalanceFactory(RebalanceFactory nativeFactory) {
    ...
    public GudRebalanceOperation start() {
        return new GemFire102RebalanceOperation(nativeFactory.start());
    }

    @Override
    public GudRebalanceOperation simulate() {
        return new GemFire102RebalanceOperation(nativeFactory.simulate());
    }
}

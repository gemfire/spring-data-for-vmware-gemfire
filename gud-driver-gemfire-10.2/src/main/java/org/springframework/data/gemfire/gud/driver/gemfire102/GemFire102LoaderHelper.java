 ...
 */
public class GemFire102LoaderHelper<K, V> implements GudLoaderHelper<K, V> {

    private final LoaderHelper<K, V> nativeHelper;

    public GemFire102LoaderHelper(LoaderHelper<K, V> nativeHelper) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFire102Region<>(nativeHelper.getRegion());
    }

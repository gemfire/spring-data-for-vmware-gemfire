 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CacheStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CacheStatistics.
 */
public class GemFire102CacheStatistics implements GudCacheStatistics, NativeWrapper<CacheStatistics> {

    private final CacheStatistics nativeStatistics;

    public GemFire102CacheStatistics(CacheStatistics nativeStatistics) {

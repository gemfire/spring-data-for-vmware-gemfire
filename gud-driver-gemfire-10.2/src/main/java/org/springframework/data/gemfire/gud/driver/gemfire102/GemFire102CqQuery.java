 ...
 * Description:
 * 2026-03-13: Created GemFire 10.2 CqQuery adapter
 */
...
/**
 * GUD API adapter for GemFire 10.2 CqQuery.
 */
public class GemFire102CqQuery implements GudCqQuery, NativeWrapper<CqQuery> {

    private final CqQuery nativeCq;

    public GemFire102CqQuery(CqQuery nativeCq) {
    ...
    public GudQuery getQuery() {
        return new GemFire102Query(nativeCq.getQuery());
    }

    @Override
    public GudCqAttributes getCqAttributes() {
        return new GemFire102CqAttributes(nativeCq.getCqAttributes());
    }

    @Override
    public GudCqAttributesMutator getCqAttributesMutator() {
        return new GemFire102CqAttributesMutator(nativeCq.getCqAttributesMutator());
    }

    @Override
    public GudCqStatistics getStatistics() {
        return new GemFire102CqStatistics(nativeCq.getStatistics());
    }
    ...
    public GudCqResults<Object> executeWithInitialResults() throws GudCqException {
        try {
            ...
            return new GemFire102CqResults<>(results);
        } catch (CqException | RegionNotFoundException e) {
            throw new GudCqException(e.getMessage(), e);
        }
    }

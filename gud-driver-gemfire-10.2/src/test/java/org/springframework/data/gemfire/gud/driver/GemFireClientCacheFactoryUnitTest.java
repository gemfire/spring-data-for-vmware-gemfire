 ...
 * Description:
 * 2026-04-02: Created unit tests verifying GUD API calls are translated to native GemFire 10.2 ClientCacheFactory calls
 */
...
/**
 * Unit Tests verifying that {@link GemFireClientCacheFactory} (GemFire 10.2 driver) correctly
 * translates GUD API calls into native {@link ClientCacheFactory} calls.
 *
 * <p>Per-server connection limit methods ARE supported in GemFire 10.1+ (including 10.2).
 */
public class GemFireClientCacheFactoryUnitTest {
	...
	@Test
	public void setPoolMinConnectionsPerServerPropagatestoNativeFactory() {
		gudFactory.setPoolMinConnectionsPerServer(3);
		verify(nativeFactory).setPoolMinConnectionsPerServer(3);
	}

	@Test
	public void setPoolMaxConnectionsPerServerPropagatestoNativeFactory() {
		gudFactory.setPoolMaxConnectionsPerServer(20);
		verify(nativeFactory).setPoolMaxConnectionsPerServer(20);
	}

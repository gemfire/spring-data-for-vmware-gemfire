 ...
 * Description:
 * 2026-04-02: Created unit tests verifying GUD API calls are translated to native GemFire 10.1 ClientCacheFactory calls
 */
...
/**
 * Unit Tests verifying that {@link GemFireClientCacheFactory} (GemFire 10.1 driver) correctly
 * translates GUD API calls into native {@link ClientCacheFactory} calls.
 *
 * <p>Per-server connection limit methods ARE supported in GemFire 10.1+.
 */

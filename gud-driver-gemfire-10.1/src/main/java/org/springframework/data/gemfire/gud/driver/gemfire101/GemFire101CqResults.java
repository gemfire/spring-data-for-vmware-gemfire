 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CqResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 CqResults.
 *
 * @param <E> the element type
 */
public class GemFire101CqResults<E> implements GudCqResults<E>, NativeWrapper<CqResults<E>> {

    private final CqResults<E> nativeResults;

    public GemFire101CqResults(CqResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        return new GemFire101CollectionType(nativeResults.getCollectionType());
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 PoolFactory adapter
...
/**
 * GUD API adapter for GemFire 10.1 PoolFactory.
 ...
 */
public class GemFire101PoolFactory implements GudPoolFactory, NativeWrapper<PoolFactory> {

    private final PoolFactory nativeFactory;

    public GemFire101PoolFactory(PoolFactory nativeFactory) {
    ...
    public GudPoolFactory setThreadLocalConnections(boolean threadLocalConnections) {
        // setThreadLocalConnections is deprecated/removed in 10.1
        return this;
    }
    ...
    public GudPool create(String name) {
        return new GemFire101Pool(nativeFactory.create(name));
    }
}

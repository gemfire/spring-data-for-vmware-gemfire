 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 SelectResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 SelectResults.
 *
 * @param <E> the element type
 */
public class GemFire101SelectResults<E> implements GudSelectResults<E>, NativeWrapper<SelectResults<E>> {

    private final SelectResults<E> nativeResults;

    public GemFire101SelectResults(SelectResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        ...
        return new GemFire101CollectionType(type);
    }

 ...
 */
public class GemFireRegionEntry<K, V> implements GudRegionEntry<K, V>, NativeWrapper<Region.Entry<K, V>> {

    private final Region.Entry<K, V> nativeEntry;

    public GemFireRegionEntry(Region.Entry<K, V> nativeEntry) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFireRegion<>(nativeEntry.getRegion());
    }

    @Override
    public GudCacheStatistics getStatistics() {
        return new GemFireCacheStatistics(nativeEntry.getStatistics());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFireRegionEntry) {
            return nativeEntry.equals(((GemFireRegionEntry<?, ?>) obj).nativeEntry);
        }
        return false;
    }

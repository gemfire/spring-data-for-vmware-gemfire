 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 RebalanceResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 RebalanceResults.
 */
public class GemFire101RebalanceResults implements GudRebalanceResults, NativeWrapper<RebalanceResults> {

    private final RebalanceResults nativeResults;

    public GemFire101RebalanceResults(RebalanceResults nativeResults) {
    ...
    public Set<GudPartitionRebalanceInfo> getPartitionRebalanceDetails() {
        return nativeResults.getPartitionRebalanceDetails().stream()
            .map(GemFire101PartitionRebalanceInfo::new)

 ...
 */
public class GemFire101EvictionAttributesMutator implements GudEvictionAttributesMutator, NativeWrapper<EvictionAttributesMutator> {

    private final EvictionAttributesMutator nativeMutator;

    public GemFire101EvictionAttributesMutator(EvictionAttributesMutator nativeMutator) {

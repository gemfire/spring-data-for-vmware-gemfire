 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 RebalanceFactory adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 RebalanceFactory.
 */
public class GemFire101RebalanceFactory implements GudRebalanceFactory, NativeWrapper<RebalanceFactory> {

    private final RebalanceFactory nativeFactory;

    public GemFire101RebalanceFactory(RebalanceFactory nativeFactory) {
    ...
    public GudRebalanceOperation start() {
        return new GemFire101RebalanceOperation(nativeFactory.start());
    }

    @Override
    public GudRebalanceOperation simulate() {
        return new GemFire101RebalanceOperation(nativeFactory.simulate());
    }
}

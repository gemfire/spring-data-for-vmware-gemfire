 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 RegionEntry adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 Region.Entry.
 *
 * @param <K> the key type
 * @param <V> the value type
 */
public class GemFire101RegionEntry<K, V> implements GudRegionEntry<K, V>, NativeWrapper<Region.Entry<K, V>> {

    private final Region.Entry<K, V> nativeEntry;

    public GemFire101RegionEntry(Region.Entry<K, V> nativeEntry) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFire101Region<>(nativeEntry.getRegion());
    }

    @Override
    public GudCacheStatistics getStatistics() {
        return new GemFire101CacheStatistics(nativeEntry.getStatistics());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFire101RegionEntry) {
            return nativeEntry.equals(((GemFire101RegionEntry<?, ?>) obj).nativeEntry);
        }
        return false;
    }

 ...
 */
public class GemFireRegionAttributes<K, V> implements GudRegionAttributes<K, V>, NativeWrapper<RegionAttributes<K, V>> {

    private final RegionAttributes<K, V> nativeAttributes;

    public GemFireRegionAttributes(RegionAttributes<K, V> nativeAttributes) {

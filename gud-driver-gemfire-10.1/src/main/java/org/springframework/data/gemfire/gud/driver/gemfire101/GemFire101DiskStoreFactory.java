 ...
 */
public class GemFire101DiskStoreFactory implements GudDiskStoreFactory, NativeWrapper<DiskStoreFactory> {

    private final DiskStoreFactory nativeFactory;

    public GemFire101DiskStoreFactory(DiskStoreFactory nativeFactory) {
    ...
    public GudDiskStore create(String name) {
        return new GemFire101DiskStore(nativeFactory.create(name));
    }
}

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CqServiceStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 CqServiceStatistics.
 */
public class GemFire101CqServiceStatistics implements GudCqServiceStatistics, NativeWrapper<CqServiceStatistics> {

    private final CqServiceStatistics nativeStatistics;

    public GemFire101CqServiceStatistics(CqServiceStatistics nativeStatistics) {

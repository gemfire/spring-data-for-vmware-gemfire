 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 EvictionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 EvictionAttributes.
 */
public class GemFire101EvictionAttributes implements GudEvictionAttributes, NativeWrapper<EvictionAttributes> {

    private final EvictionAttributes nativeAttributes;

    public GemFire101EvictionAttributes(EvictionAttributes nativeAttributes) {
    ...
    public GudObjectSizer getObjectSizer() {
        ...
        return sizer != null ? new GemFire101ObjectSizerWrapper(sizer) : null;
    }
}

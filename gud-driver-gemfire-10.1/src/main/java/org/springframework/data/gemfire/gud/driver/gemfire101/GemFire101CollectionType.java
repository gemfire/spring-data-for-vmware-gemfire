 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CollectionType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 CollectionType.
 */
public class GemFire101CollectionType implements GudCollectionType, NativeWrapper<CollectionType> {

    private final CollectionType nativeType;

    public GemFire101CollectionType(CollectionType nativeType) {
    ...
    public GudObjectType getElementType() {
        return new GemFire101ObjectType(nativeType.getElementType());
    }

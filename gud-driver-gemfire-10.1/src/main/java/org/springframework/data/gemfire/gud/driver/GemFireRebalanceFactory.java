 ...
 */
public class GemFireRebalanceFactory implements GudRebalanceFactory, NativeWrapper<RebalanceFactory> {

    private final RebalanceFactory nativeFactory;

    public GemFireRebalanceFactory(RebalanceFactory nativeFactory) {
    ...
    public GudRebalanceOperation start() {
        return new GemFireRebalanceOperation(nativeFactory.start());
    }

    @Override
    public GudRebalanceOperation simulate() {
        return new GemFireRebalanceOperation(nativeFactory.simulate());
    }
}

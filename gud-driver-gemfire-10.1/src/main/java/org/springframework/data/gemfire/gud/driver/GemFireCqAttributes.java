 ...
 */
public class GemFireCqAttributes implements GudCqAttributes, NativeWrapper<CqAttributes> {

    private final CqAttributes nativeAttributes;

    public GemFireCqAttributes(CqAttributes nativeAttributes) {
    ...
    public GudCqListener[] getCqListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFireCqListenerWrapper(listeners[i]);
        }
        return result;
    }
}

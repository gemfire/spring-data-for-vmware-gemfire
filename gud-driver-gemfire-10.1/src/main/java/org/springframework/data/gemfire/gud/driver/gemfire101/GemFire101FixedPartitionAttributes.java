 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 FixedPartitionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 FixedPartitionAttributes.
 */
public class GemFire101FixedPartitionAttributes implements GudFixedPartitionAttributes, NativeWrapper<FixedPartitionAttributes> {

    private final FixedPartitionAttributes nativeAttributes;

    public GemFire101FixedPartitionAttributes(FixedPartitionAttributes nativeAttributes) {

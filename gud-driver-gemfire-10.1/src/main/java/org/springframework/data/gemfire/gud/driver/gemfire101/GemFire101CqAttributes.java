 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CqAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 CqAttributes.
 */
public class GemFire101CqAttributes implements GudCqAttributes, NativeWrapper<CqAttributes> {

    private final CqAttributes nativeAttributes;

    public GemFire101CqAttributes(CqAttributes nativeAttributes) {
    ...
    public GudCqListener[] getCqListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFire101CqListenerWrapper(listeners[i]);
        }
        return result;
    }
}

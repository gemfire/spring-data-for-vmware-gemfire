 ...
 */
public class GemFireCqServiceStatistics implements GudCqServiceStatistics, NativeWrapper<CqServiceStatistics> {

    private final CqServiceStatistics nativeStatistics;

    public GemFireCqServiceStatistics(CqServiceStatistics nativeStatistics) {

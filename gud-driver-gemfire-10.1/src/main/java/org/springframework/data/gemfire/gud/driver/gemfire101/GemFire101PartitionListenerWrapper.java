 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 PartitionListener wrapper
 */
 ...
 */
public class GemFire101PartitionListenerWrapper implements GudPartitionListener, NativeWrapper<PartitionListener> {

    private final PartitionListener nativeListener;

    public GemFire101PartitionListenerWrapper(PartitionListener nativeListener) {

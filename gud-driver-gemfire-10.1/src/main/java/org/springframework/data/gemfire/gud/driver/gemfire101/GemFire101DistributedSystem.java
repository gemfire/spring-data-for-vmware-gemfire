 ...
 */
public class GemFire101DistributedSystem implements GudDistributedSystem, NativeWrapper<DistributedSystem> {

    private final DistributedSystem nativeSystem;

    public GemFire101DistributedSystem(DistributedSystem nativeSystem) {
    ...
    public GudDistributedMember getDistributedMember() {
        return new GemFire101DistributedMember(nativeSystem.getDistributedMember());
    }

    @Override
    public Set<GudDistributedMember> getAllOtherMembers() {
        return nativeSystem.getAllOtherMembers().stream()
            .map(GemFire101DistributedMember::new)
    ...
    public GudDistributedMember findDistributedMember(String name) {
        ...
        return member != null ? new GemFire101DistributedMember(member) : null;
    }
    ...
    public GudDistributedSystem getReconnectedSystem() {
        ...
        return reconnected != null ? new GemFire101DistributedSystem(reconnected) : null;
    }
}

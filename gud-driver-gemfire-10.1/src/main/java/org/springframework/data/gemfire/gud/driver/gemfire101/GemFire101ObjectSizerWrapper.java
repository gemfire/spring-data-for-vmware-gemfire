 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 ObjectSizer wrapper
 */
 ...
 */
public class GemFire101ObjectSizerWrapper implements GudObjectSizer, NativeWrapper<ObjectSizer> {

    private final ObjectSizer nativeSizer;

    public GemFire101ObjectSizerWrapper(ObjectSizer nativeSizer) {

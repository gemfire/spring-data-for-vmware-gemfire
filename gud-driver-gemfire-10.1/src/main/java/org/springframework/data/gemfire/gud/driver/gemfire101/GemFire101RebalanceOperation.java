 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 RebalanceOperation adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 RebalanceOperation.
 */
public class GemFire101RebalanceOperation implements GudRebalanceOperation, NativeWrapper<RebalanceOperation> {

    private final RebalanceOperation nativeOperation;

    public GemFire101RebalanceOperation(RebalanceOperation nativeOperation) {
    ...
    public GudRebalanceResults getResults() throws CancellationException, InterruptedException {
        return new GemFire101RebalanceResults(nativeOperation.getResults());
    }

    @Override
    public GudRebalanceResults getResults(long timeout, TimeUnit unit) throws InterruptedException {
        try {
            return new GemFire101RebalanceResults(nativeOperation.getResults(timeout, unit));

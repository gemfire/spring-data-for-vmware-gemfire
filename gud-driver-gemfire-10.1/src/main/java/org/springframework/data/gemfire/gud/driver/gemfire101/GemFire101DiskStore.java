 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 DiskStore adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 DiskStore.
 */
public class GemFire101DiskStore implements GudDiskStore, NativeWrapper<DiskStore> {

    private final DiskStore nativeDiskStore;

    public GemFire101DiskStore(DiskStore nativeDiskStore) {
    ...
    public int[] getSegments() {
        // GemFire 10.1 may not have getSegments - return default
        return new int[]{1};
    }
}

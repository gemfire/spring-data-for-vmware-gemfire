 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CqAttributesMutator adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 CqAttributesMutator.
 */
public class GemFire101CqAttributesMutator implements GudCqAttributesMutator, NativeWrapper<CqAttributesMutator> {

    private final CqAttributesMutator nativeMutator;

    public GemFire101CqAttributesMutator(CqAttributesMutator nativeMutator) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CacheFactory implementation
 */
...
/**
 * GemFire 10.1 implementation of GudCacheFactory.
 * Wraps the native CacheFactory and delegates all operations.
 */
public class GemFire101CacheFactory implements GudCacheFactory {

    private final CacheFactory nativeFactory;

    public GemFire101CacheFactory() {
    ...
    public GudCache create() {
        return new GemFire101Cache(nativeFactory.create());
    }
}

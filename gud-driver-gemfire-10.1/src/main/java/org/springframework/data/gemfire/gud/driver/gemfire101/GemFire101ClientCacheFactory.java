 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 ClientCacheFactory implementation
...
/**
 * GemFire 10.1 implementation of GudClientCacheFactory.
 ...
 * are not supported in GemFire 10.1. The inherited default methods will throw
 * {@link org.springframework.data.gemfire.gud.api.GudUnsupportedOperationException}.
 */
public class GemFire101ClientCacheFactory implements GudClientCacheFactory {

    private final ClientCacheFactory nativeFactory;

    public GemFire101ClientCacheFactory() {
        this.nativeFactory = new ClientCacheFactory();
    }

    public GemFire101ClientCacheFactory(Properties properties) {
    ...
    // since these features are not available in GemFire 10.1.

    @Override
    public GudClientCache create() {
        return new GemFire101ClientCache(nativeFactory.create());
    }
    ...
    public GudClientCache getAnyInstance() {
        try {
            ...
            return new GemFire101ClientCache(nativeCache);

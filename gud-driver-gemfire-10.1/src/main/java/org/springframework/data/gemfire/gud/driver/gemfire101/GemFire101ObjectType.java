 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 ObjectType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 ObjectType.
 */
public class GemFire101ObjectType implements GudObjectType, NativeWrapper<ObjectType> {

    private final ObjectType nativeType;

    public GemFire101ObjectType(ObjectType nativeType) {

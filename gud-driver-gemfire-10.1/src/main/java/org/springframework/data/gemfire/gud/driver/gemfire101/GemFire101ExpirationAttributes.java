 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 ExpirationAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 ExpirationAttributes.
 */
public class GemFire101ExpirationAttributes implements GudExpirationAttributes, NativeWrapper<ExpirationAttributes> {

    private final ExpirationAttributes nativeAttributes;

    public GemFire101ExpirationAttributes(ExpirationAttributes nativeAttributes) {

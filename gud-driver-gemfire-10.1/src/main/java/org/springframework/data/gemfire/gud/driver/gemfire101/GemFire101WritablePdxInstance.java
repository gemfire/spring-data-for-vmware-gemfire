 ...
 */
public class GemFire101WritablePdxInstance implements GudWritablePdxInstance, NativeWrapper<WritablePdxInstance> {

    private final WritablePdxInstance nativeInstance;

    public GemFire101WritablePdxInstance(WritablePdxInstance nativeInstance) {

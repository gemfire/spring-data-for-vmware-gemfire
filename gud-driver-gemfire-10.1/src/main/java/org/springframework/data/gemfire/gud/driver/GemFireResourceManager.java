 ...
 */
public class GemFireResourceManager implements GudResourceManager, NativeWrapper<ResourceManager> {

    private final ResourceManager nativeManager;

    public GemFireResourceManager(ResourceManager nativeManager) {
    ...
    public GudRebalanceFactory createRebalanceFactory() {
        return new GemFireRebalanceFactory(nativeManager.createRebalanceFactory());
    }

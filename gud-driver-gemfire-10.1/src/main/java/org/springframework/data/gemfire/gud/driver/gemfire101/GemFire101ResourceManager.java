 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 ResourceManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 ResourceManager.
 */
public class GemFire101ResourceManager implements GudResourceManager, NativeWrapper<ResourceManager> {

    private final ResourceManager nativeManager;

    public GemFire101ResourceManager(ResourceManager nativeManager) {
    ...
    public GudRebalanceFactory createRebalanceFactory() {
        return new GemFire101RebalanceFactory(nativeManager.createRebalanceFactory());
    }

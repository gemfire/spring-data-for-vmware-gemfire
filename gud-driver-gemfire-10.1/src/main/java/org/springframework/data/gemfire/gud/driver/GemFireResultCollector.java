...
public class GemFireResultCollector<OUT, AGG> implements GudResultCollector<OUT, AGG>, NativeWrapper<ResultCollector> {

    private final ResultCollector nativeCollector;

    public GemFireResultCollector(ResultCollector nativeCollector) {

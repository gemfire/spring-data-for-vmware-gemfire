 ...
 */
public class GemFire101PartitionResolverWrapper<K, V> implements GudPartitionResolver<K, V>, NativeWrapper<PartitionResolver<K, V>> {

    private final PartitionResolver<K, V> nativeResolver;

    public GemFire101PartitionResolverWrapper(PartitionResolver<K, V> nativeResolver) {

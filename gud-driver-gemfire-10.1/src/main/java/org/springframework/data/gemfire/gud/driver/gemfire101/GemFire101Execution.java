 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 Execution adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 Execution.
 *
...
public class GemFire101Execution<IN, OUT, AGG> implements GudExecution<IN, OUT, AGG>, NativeWrapper<Execution> {

    private Execution nativeExecution;

    public GemFire101Execution(Execution nativeExecution) {
    ...
    public GudResultCollector<OUT, AGG> execute(String functionId) {
        ...
        return new GemFire101ResultCollector<>(result);
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 QueryStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 QueryStatistics.
 */
public class GemFire101QueryStatistics implements GudQueryStatistics, NativeWrapper<QueryStatistics> {

    private final QueryStatistics nativeStatistics;

    public GemFire101QueryStatistics(QueryStatistics nativeStatistics) {

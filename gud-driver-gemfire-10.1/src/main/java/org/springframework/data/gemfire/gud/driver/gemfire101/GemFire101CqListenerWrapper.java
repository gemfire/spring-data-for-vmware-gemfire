 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 CqListener wrapper
 */
 ...
 */
public class GemFire101CqListenerWrapper implements GudCqListener, NativeWrapper<CqListener> {

    private final CqListener nativeListener;

    public GemFire101CqListenerWrapper(CqListener nativeListener) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 TransactionListener wrapper
 */
 ...
 */
public class GemFire101TransactionListenerWrapper implements GudTransactionListener, NativeWrapper<TransactionListener> {

    private final TransactionListener nativeListener;

    public GemFire101TransactionListenerWrapper(TransactionListener nativeListener) {

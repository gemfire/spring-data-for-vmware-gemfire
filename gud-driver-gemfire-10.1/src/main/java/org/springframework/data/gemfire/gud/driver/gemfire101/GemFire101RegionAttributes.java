 ...
 * Description:
 * 2026-03-11: Created GemFire 10.1 RegionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 RegionAttributes.
 */
public class GemFire101RegionAttributes<K, V> implements GudRegionAttributes<K, V>, NativeWrapper<RegionAttributes<K, V>> {

    private final RegionAttributes<K, V> nativeAttributes;

    public GemFire101RegionAttributes(RegionAttributes<K, V> nativeAttributes) {

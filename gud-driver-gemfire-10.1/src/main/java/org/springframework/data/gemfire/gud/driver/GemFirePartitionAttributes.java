 ...
 */
public class GemFirePartitionAttributes<K, V> implements GudPartitionAttributes<K, V>, NativeWrapper<PartitionAttributes<K, V>> {

    private final PartitionAttributes<K, V> nativeAttributes;

    public GemFirePartitionAttributes(PartitionAttributes<K, V> nativeAttributes) {
    ...
    public GudPartitionResolver<K, V> getPartitionResolver() {
        ...
        return resolver != null ? new GemFirePartitionResolverWrapper<>(resolver) : null;
    }
    ...
    public List<GudPartitionListener> getPartitionListeners() {
        ...
        return java.util.Arrays.stream(listeners)
            .map(GemFirePartitionListenerWrapper::new)
    ...
    public GudFixedPartitionAttributes[] getFixedPartitionAttributes() {
        ...
        return list.stream()
            .map(GemFireFixedPartitionAttributes::new)

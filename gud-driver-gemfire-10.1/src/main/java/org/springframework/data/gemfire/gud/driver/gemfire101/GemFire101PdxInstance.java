 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 PdxInstance adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 PdxInstance.
 */
public class GemFire101PdxInstance implements GudPdxInstance, NativeWrapper<PdxInstance> {

    private final PdxInstance nativeInstance;

    public GemFire101PdxInstance(PdxInstance nativeInstance) {
    ...
    public GudWritablePdxInstance createWriter() {
        return new GemFire101WritablePdxInstance(nativeInstance.createWriter());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFire101PdxInstance) {
            return nativeInstance.equals(((GemFire101PdxInstance) obj).nativeInstance);
        }
        return false;
    }

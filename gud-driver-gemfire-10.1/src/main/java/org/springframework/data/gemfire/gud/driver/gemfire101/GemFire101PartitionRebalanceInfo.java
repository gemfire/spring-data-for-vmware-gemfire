 ...
 * Description:
 * 2026-03-13: Created GemFire 10.1 PartitionRebalanceInfo adapter
 */
...
/**
 * GUD API adapter for GemFire 10.1 PartitionRebalanceInfo.
 */
public class GemFire101PartitionRebalanceInfo implements GudPartitionRebalanceInfo, NativeWrapper<PartitionRebalanceInfo> {

    private final PartitionRebalanceInfo nativeInfo;

    public GemFire101PartitionRebalanceInfo(PartitionRebalanceInfo nativeInfo) {

 ...
 */
public class GemFire101CacheStatistics implements GudCacheStatistics, NativeWrapper<CacheStatistics> {

    private final CacheStatistics nativeStatistics;

    public GemFire101CacheStatistics(CacheStatistics nativeStatistics) {

...
public abstract class AbstractCacheConfiguration extends AbstractAnnotationConfigSupport implements ImportAware {
	 ...
	 *
	 * Use the ClientCacheApplication Annotation to construct a {@link ClientCache cache client} application.
	 *
	 * Use the PeerCacheApplication Annotation to construct a {@link Cache peer cache} application.
	 *
	 ...
	 * of either the {@link CacheServerApplication} annotation or the PeerCacheApplication annotation

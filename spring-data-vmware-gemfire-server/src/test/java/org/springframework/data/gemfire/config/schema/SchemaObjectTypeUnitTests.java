...
public class SchemaObjectTypeUnitTests {
	...
	public void objectTypesAreSetAndCorrect() {
		...
		Set<Class<?>> expectedSchemaObjectTypes = asSet(AsyncEventQueue.class, Cache.class,
			DiskStore.class, Function.class, GatewayReceiver.class, GatewaySender.class, Index.class, Region.class, Void.class);

...
import org.springframework.data.gemfire.util.ClientRegionUtils;
...
public class ClientRegionFactoryBean<K, V> extends ConfigurableRegionFactoryBean<K, V>
	...
	ClientRegionShortcut resolveClientRegionShortcut() {
		...
		ClientRegionUtils.assertClientRegionShortcutAndPersistentAttributeAreCompatible(resolvedShortcut, this.persistent);

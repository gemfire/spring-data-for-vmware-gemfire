 ...
 *
 * For declaring and configuring new {@literal client} {@link Region Regions}, see ClientRegionFactoryBean.
 * For declaring and configuring new {@literal peer} {@link Region Regions}, see PeerRegionFactoryBean
...
public abstract class ResolvableRegionFactoryBean<K, V> extends AbstractFactoryBeanSupport<Region<K, V>>
	...
	/**
	 * Post-process the {@link Region} created by this PeerRegionFactoryBean.
	 *

...
/**
 * Abstract base class for {@link CacheFactoryBean} and ClientCacheFactoryBean classes,
...
public abstract class AbstractBasicCacheFactoryBean extends AbstractFactoryBeanSupport<GemFireCache>
	...
	/**
	 * Applies any user-defined cache configurers (e.g. ClientCacheConfigurer or PeerCacheConfigurer)

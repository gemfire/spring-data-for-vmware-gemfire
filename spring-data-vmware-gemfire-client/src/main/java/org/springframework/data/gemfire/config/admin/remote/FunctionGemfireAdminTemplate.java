...
public class FunctionGemfireAdminTemplate extends AbstractGemfireAdminOperations {
	...
	protected static final String LIST_INDEXES_FUNCTION_ID = "ListQqlIndexesFunction";

	protected static final String CREATE_REGION_FUNCTION_ID = "CreateRegionFunction";

	protected static final String CREATE_INDEX_FUNCTION_ID = "CreateOqlIndexFunction";
	...
	public Iterable<String> getAvailableServerRegionIndexes() {
		return execute(LIST_INDEXES_FUNCTION_ID);
	}

	@Override
	public void createRegion(RegionDefinition regionDefinition) {
		execute(CREATE_REGION_FUNCTION_ID, regionDefinition);
	}

	@Override
	public void createIndex(IndexDefinition indexDefinition) {
		execute(CREATE_INDEX_FUNCTION_ID, indexDefinition);
	}

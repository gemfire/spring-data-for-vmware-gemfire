...
the [configuration properties](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/reference-topics-gemfire_properties.html) and different configuration options:


- [Java API](https://gemfire.docs.pivotal.io/apidocs/)

- [cache.xml](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/reference-topics-chapter_overview_cache_xml.html)

- [gfsh](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/tools_modules-gfsh-chapter_overview.html)
  with [Cluster Configuration](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/configuring-chapter_overview.html)

- [Spring XML/Java-based configuration](bootstrap.html)

Further complexity arises from the different supported topologies:

- [Client/Server](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/topologies_and_comm-cs_configuration-chapter_overview.html)

- [Peer-to-peer](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/topologies_and_comm-p2p_configuration-chapter_overview.html)

- [Multi-site (WAN)](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/topologies_and_comm-multi_site_configuration-chapter_overview.html)
...
nodes, <a href="https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-region_options-data_hosts_and_accessors.html">data accessors</a>,
...
[How Member Discovery Works](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/topologies_and_comm-topology_concepts-how_member_discovery_works.html)
...
For more details about GemFire management and monitoring, see [Managing GemFire](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-book_intro.html)
in the GemFire product documentation.
...
[Developer REST API](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/rest_apps-book_intro.html), and
the [Pulse Monitoring Web Application](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/tools_modules-pulse-pulse-overview.html).
...
For more details about GemFire's Memcached service, see [Gemcached](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/tools_modules-gemcached-chapter_overview.html)
in the GemFire product documentation.
...
[Visual Statistics Display (VSD)](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/tools_modules-vsd-chapter_overview.html)
...
For more information about GemFire's statistics, see [Statistics](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-statistics-chapter_overview.html)
in the GemFire product documentation.
...
One of the more powerful features of GemFire is [PDX serialization](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-data_serialization-gemfire_pdx_serialization.html).
...
[org.apache.geode.pdx.PdxSerializable](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/pdx/PdxSerializable.html)
interface or you can implement and register a non-invasive
implementation of the
[org.apache.geode.pdx.PdxSerializer](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/pdx/PdxSerializer.html)
...
[org.apache.geode.pdx.ReflectionBasedAutoSerializer](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/pdx/ReflectionBasedAutoSerializer.html)
as a bean definition in a Spring context.

Alternatively, you should use Spring Data for VMware GemFire's more robust
[org.springframework.data.gemfire.mapping.MappingPdxSerializer](https://docs.spring.io/spring-data/gemfire/docs/current/api/org/springframework/data/gemfire/mapping/MappingPdxSerializer.html),
...
For more details about GemFire properties, see [GemFire properties](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/reference-topics-gemfire_properties.html)
in the GemFire product documentation.
...
[Data Regions](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/basic_config-data_regions-chapter_overview.html?hWord=N4IghgNiBcICZgC5gAQCcCmBzAlgewDsBnEAXyA).
...
[conventions]([spring-data-gemfire-docs]/#gemfire-repositories.executing-queries).
...
[DataPolicy](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/cache/DataPolicy.html),
...
For details, see [Storage and Distribution Options](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-region_options-storage_distribution_options.html)
in the GemFire product documentation.
...
For more details about GemFire Region types, see [Region Types](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-region_options-region_types.html)
in the GemFire product documentation.
...
the Cluster, implement a <a href="https://docs.spring.io/spring-data/gemfire/docs/current/api/org/springframework/data/gemfire/config/annotation/RegionConfigurer.html">RegionConfigurer</a>
...
GemFire's [org.apache.geode.cache.util.ObjectSizer](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/cache/util/ObjectSizer.html)
...
For more details about GemFire eviction, see [Eviction](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-eviction-chapter_overview.html)
in the GemFire product documentation.
...
For more details about GemFire expiration, see [Expiration](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-expiration-chapter_overview.html)
in the GemFire product documentation.
...
pluggable [Compressors](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/compression/Compressor.html),
...
[SnappyCompressor](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/compression/SnappyCompressor.html).
...
which uses the <a href="https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/compression/SnappyCompressor.html">SnappyCompressor</a>
by default. If you use another compression library, you must include dependencies for that compression library on your
application's classpath. Additionally, you must implement the <a href="https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/compression/Compressor.html">Compressor</a>
...
For more information about compression, see [Region Compression](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-region_compression.html)
in the GemFire product documentation.
...
[Managing Off-Heap Memory](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-heap_use-off_heap_management.html)
in the GemFire product documentation.
...
[Persistence and Overflow](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-storing_data_on_disk-chapter_overview.html)
in the GemFire product documentation.
...
[key](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-query_index-creating_key_indexes.html)
and [hash](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-query_index-creating_hash_indexes.html)
...
- You also need to be aware of the overhead associated in maintaining
  ...
  can be [configured](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/cache/RegionFactory.html#setIndexMaintenanceSynchronous-boolean-)
...
For more details, see [Creating Multiple Indexes at Once](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-query_index-create_multiple_indexes.html)
in the GemFire product documentation.
...
For more details about GemFire OQL queries, see [Querying](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-querying_basics-chapter_overview.html)
in the GemFire product documentation.

For more details about GemFire indexes, see
see [Working with Indexes](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-query_index-query_index.html)
in the GemFire product documentation.

For more details about GemFire Lucene queries, see [Apache Lucene® Integration](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/tools_modules-lucene_integration.html)
in the GemFire product documentation.

## <a id="configuring-continuous-queries"></a>Configuring Continuous Queries

Another very important and useful feature of GemFire is [Continuous Queries](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-continuous_querying-chapter_overview.html).
...
For more information about Continuous Querying in GemFire, see [Continuous Querying](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/developing-continuous_querying-chapter_overview.html)
in the GemFire product documentation.
...
see <a href="[spring-data-gemfire-docs]/#bootstrap-annotation-config-configurers">JCache (JSR-107) Annotations</a>
in the core
...
GemFire's [Cluster Configuration](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/configuring-cluster_config-gfsh_persist.html)
...
For more details about GemFire SSL support, see [SSL](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-security-ssl_overview.html).
...
GemFire includes an [Integrated Security](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-security-implementing_security.html)
...
- Implement the GemFire
  ...
  [CacheFactory.setSecurityManager(:SecurityManager)](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/cache/CacheFactory.html#setSecurityManager-org.apache.geode.security.SecurityManager)
...
- [ActiveDirectory](https://shiro.apache.org/static/current/apidocs/org/apache/shiro/realm/activedirectory/package-summary.html)

- [JDBC](https://shiro.apache.org/static/current/apidocs/org/apache/shiro/realm/jdbc/package-summary.html)

- [JNDI](https://shiro.apache.org/static/current/apidocs/org/apache/shiro/realm/jndi/package-summary.html)

- [LDAP](https://shiro.apache.org/static/current/apidocs/org/apache/shiro/realm/ldap/package-summary.html)

- A `Realm` supporting the [INI format](https://shiro.apache.org/static/current/apidocs/org/apache/shiro/realm/text/IniRealm.html).
...
For more details about GemFire security, see [Security](https://docs.vmware.com/en/VMware-GemFire/10.0/gf/managing-security-chapter_overview.html)
in the GemFire product documentation.
...
1. Provide an implementation of the [org.apache.geode.security.AuthInitialize](https://gemfire.docs.pivotal.io/apidocs/gf-100/org/apache/geode/security/AuthInitialize.html) interface.

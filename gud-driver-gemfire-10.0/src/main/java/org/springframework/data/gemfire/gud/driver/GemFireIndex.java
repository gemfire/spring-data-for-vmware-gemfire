 ...
 */
public class GemFireIndex implements GudIndex, NativeWrapper<Index> {

    private final Index nativeIndex;

    public GemFireIndex(Index nativeIndex) {
    ...
    public GudRegion<?, ?> getRegion() {
        return new GemFireRegion<>(nativeIndex.getRegion());
    }

    @Override
    public GudIndexStatistics getStatistics() {
        return new GemFireIndexStatistics(nativeIndex.getStatistics());
    }
}

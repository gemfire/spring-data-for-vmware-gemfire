 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 IndexStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 IndexStatistics.
 */
public class GemFire100IndexStatistics implements GudIndexStatistics, NativeWrapper<IndexStatistics> {

    private final IndexStatistics nativeStatistics;

    public GemFire100IndexStatistics(IndexStatistics nativeStatistics) {

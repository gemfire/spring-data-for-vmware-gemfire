 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CacheTransactionManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CacheTransactionManager.
 */
public class GemFire100CacheTransactionManager implements GudCacheTransactionManager, NativeWrapper<CacheTransactionManager> {

    private final CacheTransactionManager nativeManager;

    public GemFire100CacheTransactionManager(CacheTransactionManager nativeManager) {
    ...
    public GudTransactionId suspend() {
        ...
        return txId != null ? new GemFire100TransactionId(txId) : null;
    }
    ...
    public GudTransactionWriter getWriter() {
        ...
        return writer != null ? new GemFire100TransactionWriterWrapper(writer) : null;
    }
    ...
    public GudTransactionListener[] getListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            result[i] = new GemFire100TransactionListenerWrapper(listeners[i]);
        }
        return result;
    }
    ...
    public GudTransactionListener setListener(GudTransactionListener listener) {
        if (listener instanceof NativeWrapper) {
            ...
            return old != null ? new GemFire100TransactionListenerWrapper(old) : null;
        }
        return null;
    }

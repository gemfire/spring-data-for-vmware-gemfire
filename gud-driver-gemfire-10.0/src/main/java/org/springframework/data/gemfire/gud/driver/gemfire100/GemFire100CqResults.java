 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CqResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CqResults.
 *
 * @param <E> the element type
 */
public class GemFire100CqResults<E> implements GudCqResults<E>, NativeWrapper<CqResults<E>> {

    private final CqResults<E> nativeResults;

    public GemFire100CqResults(CqResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        return new GemFire100CollectionType(nativeResults.getCollectionType());
    }

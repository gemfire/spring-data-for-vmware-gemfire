 ...
 */
public class GemFire100RegionEvent<K, V> implements GudRegionEvent<K, V>, NativeWrapper<RegionEvent<K, V>> {

    private final RegionEvent<K, V> nativeEvent;

    public GemFire100RegionEvent(RegionEvent<K, V> nativeEvent) {

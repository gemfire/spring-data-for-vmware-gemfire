 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 TransactionWriter wrapper
 */
 ...
 */
public class GemFire100TransactionWriterWrapper implements GudTransactionWriter, NativeWrapper<TransactionWriter> {

    private final TransactionWriter nativeWriter;

    public GemFire100TransactionWriterWrapper(TransactionWriter nativeWriter) {

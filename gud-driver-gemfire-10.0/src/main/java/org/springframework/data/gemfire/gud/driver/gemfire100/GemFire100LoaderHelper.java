 ...
 */
public class GemFire100LoaderHelper<K, V> implements GudLoaderHelper<K, V> {

    private final LoaderHelper<K, V> nativeHelper;

    public GemFire100LoaderHelper(LoaderHelper<K, V> nativeHelper) {
    ...
    public GudRegion<K, V> getRegion() {
        return new GemFire100Region<>(nativeHelper.getRegion());
    }

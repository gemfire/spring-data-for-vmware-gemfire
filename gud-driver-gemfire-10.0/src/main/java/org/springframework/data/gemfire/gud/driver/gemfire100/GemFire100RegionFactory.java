 ...
 */
public class GemFire100RegionFactory<K, V> implements GudRegionFactory<K, V>, NativeWrapper<RegionFactory<K, V>> {

    private final RegionFactory<K, V> nativeFactory;

    public GemFire100RegionFactory(RegionFactory<K, V> nativeFactory) {

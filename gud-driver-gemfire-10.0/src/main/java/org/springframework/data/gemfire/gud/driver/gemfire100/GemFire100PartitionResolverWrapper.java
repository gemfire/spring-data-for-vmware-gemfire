 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 PartitionResolver wrapper
 */
 ...
 */
public class GemFire100PartitionResolverWrapper<K, V> implements GudPartitionResolver<K, V>, NativeWrapper<PartitionResolver<K, V>> {

    private final PartitionResolver<K, V> nativeResolver;

    public GemFire100PartitionResolverWrapper(PartitionResolver<K, V> nativeResolver) {

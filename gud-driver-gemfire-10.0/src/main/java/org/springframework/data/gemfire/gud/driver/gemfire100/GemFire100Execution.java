 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 Execution adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 Execution.
 *
...
public class GemFire100Execution<IN, OUT, AGG> implements GudExecution<IN, OUT, AGG>, NativeWrapper<Execution> {

    private Execution nativeExecution;

    public GemFire100Execution(Execution nativeExecution) {
    ...
    public GudResultCollector<OUT, AGG> execute(String functionId) {
        ...
        return new GemFire100ResultCollector<>(result);
    }

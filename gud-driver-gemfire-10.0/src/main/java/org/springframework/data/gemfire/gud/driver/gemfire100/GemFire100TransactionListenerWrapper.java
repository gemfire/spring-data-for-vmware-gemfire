 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 TransactionListener wrapper
 */
 ...
 */
public class GemFire100TransactionListenerWrapper implements GudTransactionListener, NativeWrapper<TransactionListener> {

    private final TransactionListener nativeListener;

    public GemFire100TransactionListenerWrapper(TransactionListener nativeListener) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 ResultCollector adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 ResultCollector.
 *
 * @param <OUT> the type of the result item
 * @param <AGG> the type of the aggregated result
 */
@SuppressWarnings({"unchecked", "rawtypes"})
public class GemFire100ResultCollector<OUT, AGG> implements GudResultCollector<OUT, AGG>, NativeWrapper<ResultCollector> {

    private final ResultCollector nativeCollector;

    public GemFire100ResultCollector(ResultCollector nativeCollector) {

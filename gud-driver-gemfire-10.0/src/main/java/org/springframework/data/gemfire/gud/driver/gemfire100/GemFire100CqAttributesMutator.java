 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CqAttributesMutator adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CqAttributesMutator.
 */
public class GemFire100CqAttributesMutator implements GudCqAttributesMutator, NativeWrapper<CqAttributesMutator> {

    private final CqAttributesMutator nativeMutator;

    public GemFire100CqAttributesMutator(CqAttributesMutator nativeMutator) {

 ...
 * Description:
 * 2026-03-11: Created GemFire 10.0 Pool adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 Pool.
 */
public class GemFire100Pool implements GudPool, NativeWrapper<Pool> {

    private final Pool nativePool;

    public GemFire100Pool(Pool nativePool) {
    ...
    public GudQueryService getQueryService() {
        return new GemFire100QueryService(nativePool.getQueryService());
    }

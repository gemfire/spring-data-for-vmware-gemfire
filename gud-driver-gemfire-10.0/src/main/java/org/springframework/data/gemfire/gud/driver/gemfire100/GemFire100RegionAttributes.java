 ...
 * Description:
 * 2026-03-11: Created GemFire 10.0 RegionAttributes adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 RegionAttributes.
 */
public class GemFire100RegionAttributes<K, V> implements GudRegionAttributes<K, V>, NativeWrapper<RegionAttributes<K, V>> {

    private final RegionAttributes<K, V> nativeAttributes;

    public GemFire100RegionAttributes(RegionAttributes<K, V> nativeAttributes) {

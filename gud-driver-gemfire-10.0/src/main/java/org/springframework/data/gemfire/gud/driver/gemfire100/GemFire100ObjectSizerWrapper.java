 ...
 */
public class GemFire100ObjectSizerWrapper implements GudObjectSizer, NativeWrapper<ObjectSizer> {

    private final ObjectSizer nativeSizer;

    public GemFire100ObjectSizerWrapper(ObjectSizer nativeSizer) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CacheStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CacheStatistics.
 */
public class GemFire100CacheStatistics implements GudCacheStatistics, NativeWrapper<CacheStatistics> {

    private final CacheStatistics nativeStatistics;

    public GemFire100CacheStatistics(CacheStatistics nativeStatistics) {

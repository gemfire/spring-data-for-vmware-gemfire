 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 Index adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 Index.
 */
public class GemFire100Index implements GudIndex, NativeWrapper<Index> {

    private final Index nativeIndex;

    public GemFire100Index(Index nativeIndex) {
    ...
    public GudRegion<?, ?> getRegion() {
        return new GemFire100Region<>(nativeIndex.getRegion());
    }

    @Override
    public GudIndexStatistics getStatistics() {
        return new GemFire100IndexStatistics(nativeIndex.getStatistics());
    }
}

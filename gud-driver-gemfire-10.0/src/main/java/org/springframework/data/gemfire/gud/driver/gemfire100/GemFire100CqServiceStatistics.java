 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CqServiceStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CqServiceStatistics.
 */
public class GemFire100CqServiceStatistics implements GudCqServiceStatistics, NativeWrapper<CqServiceStatistics> {

    private final CqServiceStatistics nativeStatistics;

    public GemFire100CqServiceStatistics(CqServiceStatistics nativeStatistics) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 DiskStoreFactory adapter
 * 2026-03-14: Removed setSegments (uses default that throws - added in 10.2)
 */
...
/**
 * GUD API adapter for GemFire 10.0 DiskStoreFactory.
 */
public class GemFire100DiskStoreFactory implements GudDiskStoreFactory, NativeWrapper<DiskStoreFactory> {

    private final DiskStoreFactory nativeFactory;

    public GemFire100DiskStoreFactory(DiskStoreFactory nativeFactory) {
    ...
    // since this feature is not available in GemFire 10.0.

    @Override
    public GudDiskStore create(String name) {
        return new GemFire100DiskStore(nativeFactory.create(name));
    }
}

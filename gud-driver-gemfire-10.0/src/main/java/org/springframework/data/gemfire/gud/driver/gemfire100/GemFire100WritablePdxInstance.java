 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 WritablePdxInstance adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 WritablePdxInstance.
 */
public class GemFire100WritablePdxInstance implements GudWritablePdxInstance, NativeWrapper<WritablePdxInstance> {

    private final WritablePdxInstance nativeInstance;

    public GemFire100WritablePdxInstance(WritablePdxInstance nativeInstance) {
    ...
    public GudWritablePdxInstance createWriter() {
        return new GemFire100WritablePdxInstance(nativeInstance.createWriter());
    }

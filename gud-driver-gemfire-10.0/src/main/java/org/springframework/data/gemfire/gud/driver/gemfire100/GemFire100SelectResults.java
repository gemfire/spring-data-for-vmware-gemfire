 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 SelectResults adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 SelectResults.
 *
 * @param <E> the element type
 */
public class GemFire100SelectResults<E> implements GudSelectResults<E>, NativeWrapper<SelectResults<E>> {

    private final SelectResults<E> nativeResults;

    public GemFire100SelectResults(SelectResults<E> nativeResults) {
    ...
    public GudCollectionType getCollectionType() {
        ...
        return new GemFire100CollectionType(type);
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 PartitionListener wrapper
 */
 ...
 */
public class GemFire100PartitionListenerWrapper implements GudPartitionListener, NativeWrapper<PartitionListener> {

    private final PartitionListener nativeListener;

    public GemFire100PartitionListenerWrapper(PartitionListener nativeListener) {

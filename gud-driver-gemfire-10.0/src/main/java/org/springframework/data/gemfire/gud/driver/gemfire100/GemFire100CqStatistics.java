 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CqStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CqStatistics.
 */
public class GemFire100CqStatistics implements GudCqStatistics, NativeWrapper<CqStatistics> {

    private final CqStatistics nativeStatistics;

    public GemFire100CqStatistics(CqStatistics nativeStatistics) {

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 DistributedSystem adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 DistributedSystem.
 */
public class GemFire100DistributedSystem implements GudDistributedSystem, NativeWrapper<DistributedSystem> {

    private final DistributedSystem nativeSystem;

    public GemFire100DistributedSystem(DistributedSystem nativeSystem) {
    ...
    public GudDistributedMember getDistributedMember() {
        return new GemFire100DistributedMember(nativeSystem.getDistributedMember());
    }

    @Override
    public Set<GudDistributedMember> getAllOtherMembers() {
        return nativeSystem.getAllOtherMembers().stream()
            .map(GemFire100DistributedMember::new)
    ...
    public GudDistributedMember findDistributedMember(String name) {
        ...
        return member != null ? new GemFire100DistributedMember(member) : null;
    }

    @Override
    public GudDistributedMember findDistributedMemberByName(String name) {
        // In GemFire 10.0, use findDistributedMember
    ...
    public String getSystemId() {
        // GemFire 10.0 may not have getSystemId - return name
        return getName();
    }
    ...
    public GudDistributedSystem getReconnectedSystem() {
        ...
        return reconnected != null ? new GemFire100DistributedSystem(reconnected) : null;
    }
}

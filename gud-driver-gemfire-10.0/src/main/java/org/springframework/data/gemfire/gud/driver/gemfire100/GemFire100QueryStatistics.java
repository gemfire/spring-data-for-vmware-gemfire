 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 QueryStatistics adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 QueryStatistics.
 */
public class GemFire100QueryStatistics implements GudQueryStatistics, NativeWrapper<QueryStatistics> {

    private final QueryStatistics nativeStatistics;

    public GemFire100QueryStatistics(QueryStatistics nativeStatistics) {

 ...
 */
public class GemFire100PdxInstance implements GudPdxInstance, NativeWrapper<PdxInstance> {

    private final PdxInstance nativeInstance;

    public GemFire100PdxInstance(PdxInstance nativeInstance) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GemFire100PdxInstance) {
            return nativeInstance.equals(((GemFire100PdxInstance) obj).nativeInstance);
        }
        return false;
    }

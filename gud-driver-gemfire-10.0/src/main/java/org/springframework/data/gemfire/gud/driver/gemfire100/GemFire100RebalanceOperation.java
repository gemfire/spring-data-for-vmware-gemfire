 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 RebalanceOperation adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 RebalanceOperation.
 */
public class GemFire100RebalanceOperation implements GudRebalanceOperation, NativeWrapper<RebalanceOperation> {

    private final RebalanceOperation nativeOperation;

    public GemFire100RebalanceOperation(RebalanceOperation nativeOperation) {
    ...
    public GudRebalanceResults getResults() throws CancellationException, InterruptedException {
        return new GemFire100RebalanceResults(nativeOperation.getResults());
    }

    @Override
    public GudRebalanceResults getResults(long timeout, TimeUnit unit) throws InterruptedException {
        try {
            return new GemFire100RebalanceResults(nativeOperation.getResults(timeout, unit));

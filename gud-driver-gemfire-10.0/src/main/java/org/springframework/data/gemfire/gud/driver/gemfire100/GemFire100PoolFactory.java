 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 PoolFactory adapter
...
/**
 * GUD API adapter for GemFire 10.0 PoolFactory.
 ...
 */
public class GemFire100PoolFactory implements GudPoolFactory, NativeWrapper<PoolFactory> {

    private final PoolFactory nativeFactory;

    public GemFire100PoolFactory(PoolFactory nativeFactory) {
    ...
    public GudPoolFactory setThreadLocalConnections(boolean threadLocalConnections) {
        // setThreadLocalConnections is deprecated/removed in 10.0
        return this;
    }
    ...
    public GudPool create(String name) {
        return new GemFire100Pool(nativeFactory.create(name));
    }
}

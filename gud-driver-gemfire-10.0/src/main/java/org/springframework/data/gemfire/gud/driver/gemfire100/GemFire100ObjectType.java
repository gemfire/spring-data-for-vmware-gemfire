 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 ObjectType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 ObjectType.
 */
public class GemFire100ObjectType implements GudObjectType, NativeWrapper<ObjectType> {

    private final ObjectType nativeType;

    public GemFire100ObjectType(ObjectType nativeType) {

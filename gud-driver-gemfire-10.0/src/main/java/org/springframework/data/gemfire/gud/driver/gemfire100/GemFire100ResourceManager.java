 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 ResourceManager adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 ResourceManager.
 */
public class GemFire100ResourceManager implements GudResourceManager, NativeWrapper<ResourceManager> {

    private final ResourceManager nativeManager;

    public GemFire100ResourceManager(ResourceManager nativeManager) {
    ...
    public GudRebalanceFactory createRebalanceFactory() {
        return new GemFire100RebalanceFactory(nativeManager.createRebalanceFactory());
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 CollectionType adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 CollectionType.
 */
public class GemFire100CollectionType implements GudCollectionType, NativeWrapper<CollectionType> {

    private final CollectionType nativeType;

    public GemFire100CollectionType(CollectionType nativeType) {
    ...
    public GudObjectType getElementType() {
        return new GemFire100ObjectType(nativeType.getElementType());
    }

 ...
 * Description:
 * 2026-03-13: Created GemFire 10.0 DiskStore adapter
 */
...
/**
 * GUD API adapter for GemFire 10.0 DiskStore.
 */
public class GemFire100DiskStore implements GudDiskStore, NativeWrapper<DiskStore> {

    private final DiskStore nativeDiskStore;

    public GemFire100DiskStore(DiskStore nativeDiskStore) {
    ...
    public int[] getSegments() {
        // GemFire 10.0 may not have getSegments - return default
        return new int[]{1};
    }
}
